...
var pauseRecord= document.querySelector('.pauseRecord');
var resumeRecord=document.querySelector('.resumeRecord');
...
if (navigator.mediaDevices.getUserMedia) {
  ...
  mediaRecorder.onstop = function(e) {
      ...
      audio.ontimeupdate = function(){
	      ...
	      log.textContent += ' after workaround: ' + audio.duration;
    	  audio.currentTime = 0;
    	  }
      }
 ...
 //});*/
      ...
      audio.controls = true;
      var blob = new Blob(chunks, { 'type' : 'audio/mpeg ;codecs:mp3'});
      chunks = [];
