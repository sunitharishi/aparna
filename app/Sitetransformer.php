...
class Sitetransformer extends Model 
...
{    
    ...
    protected $fillable = ['site','capacity','filename','make','location'];   
    ...
    {  
        ...
        Sitetransformer::observe(new \App\Observers\UserActionsObserver);
