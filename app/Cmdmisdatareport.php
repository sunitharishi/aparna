...
class Cmdmisdatareport extends Model 
...
{    
    ...
    protected $fillable = ['site','month','year','user_id','additional_info'];  
    ...
    {  
        ...
        Cmdmisdatareport::observe(new \App\Observers\UserActionsObserver);
