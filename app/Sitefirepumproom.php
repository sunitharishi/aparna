...
class Sitefirepumproom extends Model 
...
{    
    ...
    protected $fillable = ['site','jockey','main','dg','booster','location'];   
    ...
    {  
        ...
        Sitefirepumproom::observe(new \App\Observers\UserActionsObserver);
