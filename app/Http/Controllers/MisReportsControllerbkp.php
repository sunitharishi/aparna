...
// GET DOWNLOAD MIS
	  ...
	  $segment2 = Request::segment(2);
       ...
       $relations = [
		...
		/*  $sites_count = \App\Sites::whereIn('id', $sitearr)->count;
		 ...
		 // if(Auth::user()->id == 1){
		  foreach($sites_res_arr as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 8 || $keys == 5 || $keys == 14 || $keys == 7 || $keys == 16 ){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
		...
		$reportdatefrom_val = "1"."-".$segment4."-".$segment3;
		 ...
		 // if(Auth::user()->id == 1){
		  foreach($sites_res_arr as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 8 || $keys == 5 || $keys == 14 || $keys == 7 || $keys == 16 || $keys == 17){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
		...
		$reportdate_val = $lastdatearr[2]."-".$segment4."-".$segment3;
		 ...
		 // if(Auth::user()->id == 1){
		  foreach($siteattrname as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 18 || $keys == 5 || $keys == 7){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
		...
		$twrs_fr = array();
		 ...
		 if($resnoc_count > 0){
			...
			'lakeb' => $hill_lake_fr,
			'aurares' => $aura_fr,
			'pageoneval' => $pageone_val,
			'pagetwoval' => $pagetwo_val,
		...
		$reportdate_val = $lastdatearr[2]."-".$segment4."-".$segment3;
		 ...
		 if(Auth::user()->id == 1){
		  ...
		  //if(Auth::user()->id == 1){
		  foreach($siteattrname as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 8 || $keys == 5 || $keys == 14 || $keys == 7 || $keys == 19 || $keys == 18 || $keys == 17){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
		...
		//  if(Auth::user()->id == 1){
		  foreach($siteattrname as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 8 || $keys == 5 || $keys == 14 || $keys == 7 || $keys == 18 || $keys == 19 || $keys == 17){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
			  ...
			  if (count($issuecount) > 0) {
				  ...
				  $fi = 0;
						...
						$pdf = new \PDFMerger();
						 ...
						 $pdf->merge('file', storage_path('/pdffiles/stpstatus.pdf'));
		...
		$reportdate_val = $lastdatearr[2]."-".$segment4."-".$segment3;
		 ...
		 // if(Auth::user()->id == 1){
		  foreach($siteattrname as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 8 || $keys == 5 || $keys == 14 || $keys == 7 || $keys == 16 || $keys == 19 || $keys == 17){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
			  ...
			  if (count($issuecount) > 0) {
				  ...
				  $fi = 0;
						...
						$pdf = new \PDFMerger();
						 ...
						 $pathForTheMergedPdf_fire_firesafe = storage_path() . "/pdffiles/wsp/finalresult.pdf";
						 
						 $pdf->merge('file', storage_path('/pdffiles/wspstatus.pdf'));
	  ...
	  //// END CMD AND RMD
		...
		if($res_count > 0){
		  ...
		  foreach($sitearrname1 as $keys => $site){
		    if($keys == 8 || $keys == 5 || $keys == 14 || $keys == 7 || $keys == 16 || $keys == 17 ){
			   $skarra[0] = 8;
			   $skarra[1] = 5;
			   $skarra[2] = 14;
			   $skarra[3] = 7;
		...
		$exist_SecTwo_Secu = $exist_SecTwo;
			...
			'existsec' => $exist_Sec,
			'existsectwo' => $exist_SecTwo,
			'pagenumberval_one' => 1 + $fcount,
			'pagenumberval_rwo' => 2 + $fcount,
			];     
			  $fcount = $fcount + 2;
		 }
		...
		$reportdate_val = $lastdatearr[2]."-".$segment4."-".$segment3;
		 ...
		 // if(Auth::user()->id == 1){
		  foreach($siteattrname as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 19 || $keys == 18 || $keys == 8 || $keys == 5 || $keys == 14 || $keys == 7){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
		...
		// } 
		  ...
		  //if(Auth::user()->id == 1){
		   $siteattrnamenew_one = array();
		  foreach($siteattrname as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 19 ){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
		...
		//	}
		 ...
		 // }
		  ...
		  $relations = [
			...
			'deployment' => $deployment, 
			 'pagenumberval_one' => 1 + $fcount,
			 'pagenumberval_tw' => 2 + $fcount,
			 'pagenumberval_thr' => 3 + $fcount,
			 'pagenumberval_fr' => 4 + $fcount,
			 'pagenumberval_fv' => 5 + $fcount,
			];   
			$fcount = $fcount + 5;
		 //  return view('misfiles.view.horticulturepestone', $relations);
   ...
   $skarra= array();
	...
	//	 }    		  
		...
		//  if(Auth::user()->id == 1){
		  foreach($siteattrname as $keys => $site){
		    if($keys == 9 || $keys == 15 || $keys == 13 || $keys == 11 || $keys == 19 || $keys == 18 || $keys == 8 || $keys == 5 || $keys == 14 || $keys == 7 || $keys == 16){
			   $skarra[0] = 9;
			   $skarra[1] = 15;
			   $skarra[2] = 13;
			   $skarra[3] = 11;
		...
		if($res_count > 0){
			...
			$formfieldarray = \App\Indentedmisreport::where($matchfields)->get();
		     ...
		     foreach ($Recordcount as $k => $indrec)  {
					 $indrec = $indentrep_Array[$k]; 
					 if (count($indrec) > 0) {
                     if($rowcount >= 20) { if($rowcount % 20 == 0 || $rowcount % 20 >= 15) { $xcn = $xcn + 1;   $rowcount  = $rowcount % 20;} } 
		...
		if($res_count > 0){
			...
			$formfieldarray = \App\Occupancymisreport::where($matchfields)->get();
		     ...
		     foreach ($Recordcount as $k => $indrec)  {
					 $indrec = $indentrep_Array[$k]; 
					 if (count($indrec) > 0) {
                     if($rowcount >= 24) { if($rowcount % 24 == 0 || $rowcount % 24 >= 17) { $xcn = $xcn + 1;   $rowcount  = $rowcount % 24;} } 
