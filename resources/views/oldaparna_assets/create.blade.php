...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['aparnaassets.store'],'id'=>'frmcommAsset','onsubmit'=>'return community_assets_save()']) !!}
  ...
  <div class="community-assets-create">
    ...
    <a href="{{ route('aparnaassets.index') }}" class="btn aturl btn-cancell">Cancel</a>
    {!! Form::close() !!}
    </div>
 </div>
 </div>
