...
<div class="misback-button"><a href="/misreportsoptions/<?php echo $year."/".$month ?>">Back</a></div>
    ...
    <h3 class="page-title apppna">AMC Track Report</h3>
	...
	{!! Form::open(['files' => 'true','route' => 'uploadexcel.saveamctrackuploadfile','role' => 'form', 'class'=>'form-inline upload-attendance-form', 'onsubmit' =>"return subform()"]) !!}
	<div class="row">
           ...
           <div class="form-group ulpoad-new">
						  ...
						  <div class="help-block"><strong style="color:#ff2518;">Note!</strong> <span style="color:#000;font-weight:bold;font-size:12px;">Only xls or xlsx file is allowed!!</span> <a href="{!! URL::to('/uploads/progress_amctrack_sample.xlsx') !!}">Click here for Sample File.</a></div>
