...
<div class="misback-button"><a href="/auditupload/<?php echo $year."/".$month ?>">Back</a></div>
    ...
    <h3 class="page-title apppna">Club House Rate Card</h3>
	...
	{!! Form::open(['files' => 'true','route' => 'uploadexcel.saveauditchratecard','role' => 'form', 'class'=>'form-inline upload-attendance-form', 'onsubmit' =>"return subform()"]) !!}
	<div class="row">
           ...
           <div class="form-group ulpoad-new">
						  ...
						  <div class="help-block"><strong style="color:#ff2518;">Note!</strong> <span style="color:#000;font-weight:bold;font-size:12px;">Only xls or xlsx file is allowed!!</span> <a href="{!! URL::to('/uploads/ch_rate_card.xlsx') !!}">Click here for Sample File.</a></div>
