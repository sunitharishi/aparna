 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
     ...
     <div class="panel panel-default panelmar tsas-crseations">
        <div class="panel-heading fms-pmtw-heading">
          AUDIT -> FMS - PPM/TW
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p>  
        </div>
         <div class="panel-body fms-ppmtw-body">
            ...
            <label class="label-individual-site">Sites<span>:</span></label> 
             ...
             <?php  $year = date("Y");
               ...
               <div class="individual-buttons">
                      <button onclick="getfmsppmtwauditreports()" class="btn btn-primary">Go..</button>
                 </div>
                 <div class="individual-buttons" style="padding-left: 10px;">
                   <button onclick="getfmsppmtwauditreportexport()" class="btn btn-primary">Export..</button>
                </div>
               </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getfmsppmtwauditreports(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getfmsppmtwauditreports') }}',
  ...
  function getfmsppmtwauditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getfmsppmtwauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
