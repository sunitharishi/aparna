 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations">
        <div class="panel-heading pms-watering">
          AUDIT -> PMS - WATERING  
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p> 
        </div>
         <div class="panel-body pms-watering-audit">
            ...
            <label class="label-individual-site">Sites<span>:</span></label>
             ...
             <div class="individual-buttons">
               ...
               <button onclick="getpmswaterAuditreportexport()" class="btn btn-primary">Export..</button>
              </div>
            </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getpmswaterauditreports') }}',
  ...
  function getpmswaterAuditreportexport()
  {
	   var fromdate = $("#fromdate").val();
	   var todate = $("#todate").val();
	   var site = $("#site").val();
	   window.location = "/getpmswaterauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
 }
</script> 
