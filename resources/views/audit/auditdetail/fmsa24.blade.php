            ...
            <label class="label-individual-site">Sites<span>:</span></label> 
             ...
             <?php  $year = date("Y");
               ...
               <div class="individual-buttons">
                      <button onclick="getfmstwauditreports()" class="btn btn-primary">Go..</button>
                       <button onclick="getfmstwauditreportexport()" class="btn btn-primary">Export..</button>
                </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getfmstwauditreports(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getfmstwauditreports') }}',
  ...
  function getfmstwauditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getfmstwauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script>
