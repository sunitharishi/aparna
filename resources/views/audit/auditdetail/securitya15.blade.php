   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations audit-editreports">
        <div class="panel-heading">
           AUDIT -> SECURITY - Less Than 50 kgs 
         ...
         ?>
             ...
             <div class="individual-buttons" style="padding-left: 20px;">
                   <button onclick="geta50Auditreportexport()" class="btn btn-primary">Export..</button>
             </div>
            </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecurityage50auditreports') }}',
  ...
  function geta50Auditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecage50Auditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
