   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations audit-editreports">
        <div class="panel-heading">
           AUDIT -> SECURITY - LESS THAN 20 years 
         ...
         ?>
             ...
             <div class="individual-buttons">
                   ...
                   <button onclick="geta16Auditreportexport()" class="btn btn-primary">Export..</button>
             </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecage20auditreports') }}',
  ...
  function geta16Auditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecage20Auditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
