 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
     ...
     <div class="panel panel-default panelmar tsas-crseations">
        <div class="panel-heading fms-power-heading">
          AUDIT -> FMS -  Power Factor
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p>  
        </div>
         <div class="panel-body fms-power-bocy">
             ...
             <?php  $year = date("Y");
               ...
               <div class="individual-buttons">
                 ...
                 <div class="individual-buttons" style="padding-left: 10px;">
                   <button onclick="geta5Auditreportexport()" class="btn btn-primary">Export..</button>
                </div>
               </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getfmspwrfauditreports') }}',
  ...
  function geta5Auditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getfmspwrfauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
