 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
     ...
     <div class="panel panel-default panelmar tsas-crseations">
        <div class="panel-heading fms-swimmingpool-heading">
          AUDIT -> FMS -  SWIMMING POOL PH
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p>  
        </div>
         <div class="panel-body fms-swimmingpool-body">
            ...
            <label class="label-individual-site">Sites<span>:</span></label> 
             ...
             <?php  $year = date("Y");
               ...
               <div class="individual-buttons">
                      <button onclick="getfmssppauditreports()" class="btn btn-primary">Go..</button>
                      <button onclick="getfmssppauditreportexport()" class="btn btn-primary">Export..</button>
                 </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getfmssppauditreports(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getfmssppauditreports') }}',
  ...
  function getfmssppauditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getfmssppauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
