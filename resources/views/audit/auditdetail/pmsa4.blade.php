 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations">
        <div class="panel-heading housekeeping-attendance">
          AUDIT -> PMS - HOUSE KEEPING ATTENDANCE (Supervisor + Helpers) 
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p>     
        </div>
         <div class="panel-body pms-houattendance">
            ...
            <div class="individual-buttons">
                <button onclick="getpmshousekeepingsuphelpauditreports()" class="btn btn-primary">Go..</button>
                <button onclick="getpmshousekeepingsuphelpauditreportexport()" class="btn btn-primary">Export..</button>
             </div>
                    </div> 
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getpmshousekeepingsuphelpauditreports(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getpmshousekeepingsuphelpauditreports') }}',
  ...
  function getpmshousekeepingsuphelpauditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getpmshousekeepingsuphelpauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script>
