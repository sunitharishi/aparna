...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecurityanauditreports') }}',
  ...
  function geta4Auditreportexport(){
   ...
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecurityanauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
