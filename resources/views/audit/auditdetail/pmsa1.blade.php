...
<div class="panel panel-default panelmar tsas-crseations">
    <div class="panel-heading pms-darsubmission-heading">
    	AUDIT -> PMS -  DAR SUBMISSION
        <p class="pull-right audit-backbutton">
        	<a href="/audit" class="">Back</a> 
        </p>
    </div>
<div class="panel-body pms-darsubmission-body">
    <div class="pms-areport">
        ...
        <td>{{ date("F j, Y, g:i a",strtotime($tt['updated_at'])) }}</td>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getpmsdarauditreports') }}',
  ...
  function getpmsdarAuditreportexport(){
   ...
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getpmsdarauditreportsexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script>
