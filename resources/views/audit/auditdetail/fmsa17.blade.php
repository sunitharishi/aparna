 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
     ...
     <div class="panel panel-default panelmar tsas-crseations">
        <div class="panel-heading fms-residualchroline-heading">
          AUDIT -> FMS -  RESIDUAL CHROLINE
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p>  
        </div>
         <div class="panel-body fms-residualchroline-body">
            ...
            <label class="label-individual-site">Sites<span>:</span></label> 
             ...
             <?php  $year = date("Y");
               ...
               <div class="individual-buttons">
                      <button onclick="getfmsfrcauditreports()" class="btn btn-primary">Go..</button>
                      <button onclick="getfmsfrcauditreportexport()" class="btn btn-primary">Export..</button>
                 </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getfmsfrcauditreports(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getfmsfrcauditreports') }}',
  ...
  function getfmsfrcauditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getfmsfrcauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
