...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getchuserauditreports') }}',
  ...
  function getpmsdarAuditreportexport(){
   ...
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getchuserauditreportsexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script>
