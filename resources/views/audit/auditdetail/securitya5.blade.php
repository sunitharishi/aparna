...
<style type="text/css">
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations audit-solarfencingstatus">
        <div class="panel-heading">
            AUDIT -> SECURITY - SOLAR FENCING WORKING STATUS
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecuritysfwsauditreports') }}',
  ...
  function geta5Auditreportexport(){
   ...
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecuritysfwsauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
