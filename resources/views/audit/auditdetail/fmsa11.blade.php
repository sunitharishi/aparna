 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations">
        <div class="panel-heading fms-pointsdis-heading">
           AUDIT ->  FMS - POINTS DISCUSSED IN DAILY MEETING
            <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p>
        </div>
        
		<div class="panel-body fms-pointsdis-body">
            ...
            <label class="label-individual-site">Sites<span>:</span></label> 
             ...
             <?php  $year = date("Y");
               ...
               <div class="individual-buttons">
                      <button onclick="getfmshodauditreports()" class="btn btn-primary">Go..</button>
                      <button onclick="getfmshodauditreportexport()" class="btn btn-primary">Export..</button>
                </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getfmshodauditreports(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('auditreport.getfmshodauditreports') }}',
  ...
  function getfmshodauditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getfmshodauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script>
