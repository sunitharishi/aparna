   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations employee-attended-daily">
        <div class="panel-heading">
             AUDIT -> SECURITY - Employees attended daily beriefing meeting
         ...
         ?>
             ...
             <div class="individual-buttons">
                   ...
                   <button onclick="geta19Auditreportexport()" class="btn btn-primary">Export..</button>
             </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecuritydbmauditreports') }}',
  ...
  function geta19Auditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecuritydbmauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
