...
<style type="text/css">
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations employee-attended-daily">
        <div class="panel-heading security-guard-lady">
             AUDIT -> SECURITY - PHYSICAL ATTENDANCE OF GUARD / LADY GUARD / HEAD GUARD / ASO / SO
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p> 
        </div>
         <div class="panel-body people-attended">
         ...
         ?>
             ...
             <div class="individual-buttons">
                ...
                <button onclick="geta17Auditreportexport()" class="btn btn-primary">Export..</button>
             </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecurityphaauditreports') }}',
  ...
  function geta17Auditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecurityphaauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
