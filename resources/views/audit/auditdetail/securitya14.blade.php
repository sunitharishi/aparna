        ...
        <div class="panel-heading">
         ...
         ?>
             ...
             <div class="individual-buttons">
                   ...
                   <button onclick="geta14Auditreportexport()" class="btn btn-primary">Export..</button>
             </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecurityheightauditreports') }}',
  ...
  function geta14Auditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecurityheightauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
