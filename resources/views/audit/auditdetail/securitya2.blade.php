...
<style type="text/css">
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations audit-longheading">
        <div class="panel-heading maids-drivers-vendors-heading">
           AUDIT -> SECURITY - ALLOWED WITHOUT ID CARDS (maids / drivers / vendors / interiors / others)
           <p class="pull-right audit-backbutton">
             <a href="/audit" class="">Back</a> 
          </p> 
        </div>
         <div class="panel-body audit-maids-drivers">
         ...
         ?>
             ...
             <div class="individual-buttons" style="padding-left: 10px;">
                   <button onclick="geta2Auditreportexport()" class="btn btn-primary">Export..</button>
             </div>
            </div>
...
$('#todate').datepicker({ dateFormat: "dd-mm-yy" });
  ...
  function getctptAuditreport(){
   ...
   var site = $("#site").val();
      ...
      $.ajax({
        type: "get",
        cache:false,
        url: '{{ route('auditreport.getsecuritywicauditreports') }}',
  ...
  function geta2Auditreportexport(){
   var fromdate = $("#fromdate").val();
   var todate = $("#todate").val();
   var site = $("#site").val();
   window.location = "/getsecuritywicauditreportexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"";    
     }
  </script> 
