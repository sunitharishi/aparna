   ...
   <!-- <h3 class="page-title">Tasks</h3>-->
    ...
    <div class="panel panel-default panelmar tsas-crseations ssnag-reportss">
        ...
        <div class="panel-heading">
         ...
         <div style="float:left;">Eyesore</div>
         ...
         <div class="panel-body snag-body-section">
			...
			<div class="individual-buttons">
                ...
                <button onclick="getexcelreport()" class="btn btn-primary">Download</button>
             </div>
			 
			 <div style="float:right;">
				 <a  href="/geteyesorecreate" class="btn btn-primary">Add Eyesore</a>
			</div>
  ...
  function statusChange()
  {
   ...
   var status = $("#status").val();
      ...
      $.ajax({
        ...
        url: '{{ route('auditreport.getsorereports') }}',

        data: { fromdate: fromdate, todate: todate, site: site, status: status},
  ...
  $("#overlay1").fadeOut("slow");
...

     {
		   ...
		   var status = $("#status").val();
            ...
            window.location.href = "/getsoreexport?fromdate="+fromdate+"&todate="+todate+"&site="+site+"&status="+status;
...
@section('javascript')
    ...
    <script type="text/javascript">
		...
		function selectSites()
		{
			...
			type: "get",
			cache:false,
			url: '{{ route('audit.soresiteselect') }}',
			data: { site: site},
			success: function( response ) 
			{	
				 $("#validresponse").html(response);
