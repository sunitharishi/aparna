...
@section('content')
    ...
    <h3 class="page-title"><span>Progress Reports</span></h3>
</div>
    <div class="row">  
             ...
             <div class="selection-producure power-report">
              <span style="color:#ff2518;font-weight:bold;width:40px;float:left;line-height:29px;">Year:</span><div class="dlyrep-select"> 
                   ...
                   <!--   <span class="misreports-labelindex">Index Date:</span> 
					...
					<tbody>
					 <tr> 
					  <td><b>Common Area Power Consumption</b></td>
				<!--	  <td><i class="fa fa-check" aria-hidden="true"></i></td>-->
					  <th class="misadg"><div id="target4" class="edt"><button type="button" id="poweredt" class="btn btn-inverse btn-xs">Edit</button></div><div id="target2" class="edt"><button type="button" id="powerview"  class="btn btn-success btn-xs">View</button></div><button type="button" id="powerprint" class="btn btn-print btn-xs"> Print</button> <button type="button" id="powerdownload" class="btn btn-download btn-xs boredow">Download</button></th>
					</tr> 
                    
                     <tr> 
					  <td><b>AMC Tracker</b></td>
				<!--	  <td><i class="fa fa-check" aria-hidden="true"></i></td>-->
					  <th class="misadg"><div id="target4" class="edt"><button type="button" id="amcedt" class="btn btn-inverse btn-xs">Edit</button></div><div id="target2" class="edt"><button type="button" id="amcview"  class="btn btn-success btn-xs">View</button></div><button type="button" id="amcprint" class="btn btn-print btn-xs"> Print</button> <button type="button" id="amcdownload" class="btn btn-download btn-xs boredow">Download</button></th>
					</tr>  
...
$('#example1').datepicker({ dateFormat: "dd-mm-yy" });
	...
	$( "#poweredt" ).click(function() {
		...
		window.location.href = "/getprogressreportrecupdate/2/"+year+"/"+month; 
		}
