...
/*.mock-pump .last-mock-drill label
{
 height: 40px;
 line-height: 63px;
}*/
...
-->
                     ...
                     <div class="col-sm-12 col-xs-12 fire-hydrant" style="padding-top:10px;padding-bottom:10px;">
                     	...
                     	<div class="col-sm-4 col-xs-4 training-conducted">
                             ...
                             <div class="col-sm-4 col-xs-4 training-date">
                             	...
                             	{!! Form::text('training_on', $res['training_on'], ['class' => 'form-control', 'placeholder' => '']) !!}
                        ...
                        <div class="col-sm-6 col-xs-6 firesafety-conducted subject">
                        	...
                        	<label class="col-sm-2 col-xs-2">Subject:</label>
                             ...
                             <div class="col-sm-10 col-xs-10 firesafety-checklist">
								...
								<?php  $verifyarr = array(); if($res['trainsubject']) {



													$verifyarr= explode(",",$res['trainsubject']); }  ?>



                                	<li><input type="checkbox" value="Fire Extinguisher" name="trainsubject[]" <?php if(in_array('Fire Extinguisher', $verifyarr)) echo "checked"; ?>>Fire Extinguisher</li>



                                    <li><input type="checkbox" value="Hydrant" name="trainsubject[]"  <?php if(in_array('Hydrant', $verifyarr)) echo "checked"; ?>>Hydrant</li>



                                    <li><input type="checkbox" value="Lift Rescue" name="trainsubject[]"  <?php if(in_array('Lift Rescue', $verifyarr)) echo "checked"; ?>>Lift Rescue</li>



                                    <li><input type="checkbox" value="Mock Drill" name="trainsubject[]"  <?php if(in_array('Mock Drill', $verifyarr)) echo "checked"; ?>>Mock Drill</li>



                                    <li><input type="checkbox" value="Fire Alarm" name="trainsubject[]"  <?php if(in_array('Fire Alarm', $verifyarr)) echo "checked"; ?>>Fire Alarm</li>
                     ...
                     <div class="col-sm-12 col-xs-12 people-trained" style="padding-bottom:0px;">
                     	...
                     	<div class="col-sm-4 col-xs-4 traning-conducted">
                             ...
                             <div class="col-sm-4 col-xs-4 till-date">
                             	...
                             	{!! Form::text('trainingsnumtilldate', $res['trainingsnumtilldate'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                        	...
                        	<label class="col-sm-2 col-xs-2">People Trained:</label>
                             ...
                             <div class="col-sm-10 col-xs-10 firesafety-checklist">
                             	...
                             	<ul>
								  ...
								  <?php  $peoarr = array(); if($res['trainedpeople']) {



										 $peoarr= explode(",",$res['trainedpeople']); }  ?>
                                	...
                                	<li><input type="checkbox" value="Security Guards" name="trainedpeople[]" <?php if(in_array('Security Guards', $peoarr)) echo "checked"; ?>>Security Guards</li>



                                    <li><input type="checkbox" value="Technicians" name="trainedpeople[]" <?php if(in_array('Technicians', $peoarr)) echo "checked"; ?>>Technicians</li>



                                    <li><input type="checkbox" value="Residents" name="trainedpeople[]" <?php if(in_array('Residents', $peoarr)) echo "checked"; ?>>Residents </li>



                                    <li><input type="checkbox" value="Staff" name="trainedpeople[]" <?php if(in_array('Staff', $peoarr)) echo "checked"; ?>>Staff</li>
                    ...
                    <div class="col-sm-1 col-xs-1 sup-total">
                               ...
                               <?php if(isset($validres['attendance'])) { $att =$validres['attendance']; } else { $att = ""; } ?>
                                  ...
                                  {!! Form::text('suptotattendance', $att, ['class' => 'form-control number', 'placeholder' => '', 'readonly']) !!}
                                ...
                                <div class="col-sm-1 col-xs-1 sup-present">
                                 ...
                                 {!! Form::text('suppresentattendance', $res['suppresentattendance'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                  ...
                                  <div class="col-sm-1 col-xs-1 sup-attendance">
										 ...
										 {!! Form::text('supattendance',  $res['supattendance'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                  </div>
                                ...
                                <div class="col-sm-1 col-xs-1 stewards">
                                  ...
                                  {!! Form::text('stewardsattendance', $res['stewardsattendance'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                               ...
                               <div class="col-sm-2 col-xs-2 night-shift">
                                  ...
                                  <label class="control-label col-sm-12 col-xs-12" for="email">Night shift steward</label>
                                   ...
                                   {!! Form::text('nightshiftattendance', $res['nightshiftattendance'], ['class' => 'form-control number', 'placeholder' => '']) !!}
...
<div class="col-sm-3 col-xs-3 jockey-status" style="padding-top:10px;">
          ...
          <div class="col-sm-3 col-xs-3 for-margin-label jockey-auto">
                <label>Auto</label>
                {!! Form::text('jockeypumpauto', $res['jockeypumpauto'], ['class' => 'form-control number jockeyClass', 'id'=>'jkauto', 'placeholder' => '']) !!}
              </div>
              <div class="col-sm-3 col-xs-3 for-margin-label jockey-manual">
                <label>Manual</label>
                {!! Form::text('jockeypumpmanual', $res['jockeypumpmanual'], ['class' => 'form-control number jockeyClass',  'id'=>'jkman', 'placeholder' => '']) !!}
              </div>
               <div class="col-sm-3 col-xs-3 for-margin-label jockey-off">
                <label>OFF</label>
               {!! Form::text('jockeypumpoff', $res['jockeypumpoff'], ['class' => 'form-control number jockeyClass',  'id'=>'jkoff', 'placeholder' => '']) !!}
              </div>
              <div class="col-sm-3 col-xs-3 for-margin-label jockey-not-working">
                <label>Not Working</label>
               {!! Form::text('jockeypumpnotworking', $res['jockeypumpnotworking'], ['class' => 'form-control number jockeyClass',  'id'=>'jknw', 'placeholder' => '']) !!}
              </div>
        </div>
		...
		<div class="col-sm-3 col-xs-3 dg-status" style="padding-top:10px;">
		  ...
		  <div class="col-sm-3 col-xs-3 for-margin-label dg-auto">
				<label>Auto</label>
			   {!! Form::text('dgpumpauto', $res['dgpumpauto'], ['class' => 'form-control number dgpumpClass', 'id'=>'dgpumpauto', 'placeholder' => '']) !!}
			  </div>
			  <div class="col-sm-3 col-xs-3 for-margin-label dg-manual">
				<label>Manual</label>
				{!! Form::text('dgpumpmanual', $res['dgpumpmanual'], ['class' => 'form-control number dgpumpClass', 'id'=>'dgpumpmanual', 'placeholder' => '']) !!}
			  </div>
			  <div class="col-sm-3 col-xs-3 for-margin-label dg-off">
				<label>OFF</label>
			   {!! Form::text('dgpumpoff', $res['dgpumpoff'], ['class' => 'form-control number dgpumpClass', 'id'=>'dgpumpoff', 'placeholder' => '']) !!}
			  </div>
			  <div class="col-sm-3 col-xs-3 for-margin-label dg-not-working">
				<label>Not Working</label>
			   {!! Form::text('dgpumpnotworking', $res['dgpumpnotworking'], ['class' => 'form-control number dgpumpClass','id'=>'dgpumpnotworking', 'placeholder' => '']) !!}
			  </div>
		</div>
		
		 <div class="col-sm-3 col-xs-3 dg-status" style="padding-top:10px;">
              <h5><b>Diesel Level</b></h5>
			  <?php if(isset($validres['dgtank'])) { $dgtank =$validres['dgtank']; } else { $att = ""; } ?>
			  <input type="hidden" name="dgtank" id="Diesel_Level" value="<?php echo $dgtank; ?>" />
              <div class="col-sm-4 col-xs-4 for-margin-label dg-auto">
                    <label>Minimum</label>
				   {!! Form::text('dglevel_min', $res['dglevel_min'], ['class' => 'form-control number dgpumpClass'.(($res['dglevel_min'] == "")?' validres':''), 'id' => 'dglevel_min', 'placeholder' => '', 'onchange'=>'checkdlevel()']) !!}
                  </div>
                  <div class="col-sm-4 col-xs-4 for-margin-label dg-manual">
                    <label>Medium</label>
					{!! Form::text('dglevel_max', $res['dglevel_max'], ['class' => 'form-control number dgpumpClass'.(($res['dglevel_max'] == "")?' validres':''), 'id' => 'dglevel_max', 'placeholder' => '', 'onchange'=>'checkdlevel()']) !!}
                  </div>
                  <div class="col-sm-4 col-xs-4 for-margin-label dg-off">
                    <label>High</label>
				   {!! Form::text('dglevel_high', $res['dglevel_high'], ['class' => 'form-control number dgpumpClass'.(($res['dglevel_high'] == "")?' validres':''), 'id' => 'dglevel_high', 'placeholder' => '', 'onchange'=>'checkdlevel()']) !!}
                  </div>
         </div>
		 ...
		 <div class="col-sm-3 col-xs-3 dg-status" style="padding-top:10px;">
              ...
              <div class="col-sm-4 col-xs-4 for-margin-label dg-auto">
                  ...
                  <div class="col-sm-4 col-xs-4 for-margin-label dg-manual">
                    <label>Not Working</label>
					{!! Form::text('bnworking', $res['bnworking'], ['class' => 'form-control number dgpumpClass'.(($res['bnworking'] == "")?' validres':''), 'id'=>'bnworking', 'placeholder' => '', 'onchange'=>'bnotworking()']) !!}
                  </div>
                  <div class="col-sm-4 col-xs-4 for-margin-label breason" style="display: <?php if(isset($res['bnwreason']) && $res['bnwreason']!="") echo 'block'; else echo 'none'; ?>">
                    <label>Reason</label>
                   {!! Form::text('bnwreason', $res['bnwreason'], ['class' => 'form-control number dgpumpClass', 'id'=>'bnwreason', 'placeholder' => '']) !!}
                  </div>
         </div>
    ...
    <div class="col-sm-4 col-xs-4 main-status" style="padding-top:10px; padding-left:20px;">
      <h5><b>Main Pump</b></h5>
      <div class="col-sm-3 col-xs-3 for-margin-label main-auto">
            <label>Auto</label>
            {!! Form::text('mainpumpauto', $res['mainpumpauto'], ['class' => 'form-control number mainpumpClass',  'id'=>'mainpumpauto', 'placeholder' => '']) !!}
          </div>
          <div class="col-sm-3 col-xs-3 for-margin-label main-manual">
            <label>Manual</label>
           {!! Form::text('mainpumpmanual', $res['mainpumpmanual'], ['class' => 'form-control number mainpumpClass', 'id'=>'mainpumpmanual', 'placeholder' => '']) !!}
          </div>
           <div class="col-sm-3 col-xs-3 for-margin-label main-off">
            <label>OFF</label>
            {!! Form::text('mainpumpoff', $res['mainpumpoff'], ['class' => 'form-control number mainpumpClass', 'id'=>'mainpumpoff', 'placeholder' => '']) !!}
          </div>
          <div class="col-sm-3 col-xs-3 for-margin-label main-not-working">
            <label>Not Working</label>
            {!! Form::text('mainpumpnotworking', $res['mainpumpnotworking'], ['class' => 'form-control number mainpumpClass', 'id'=>'mainpumpnotworking', 'placeholder' => '']) !!}
          </div>
    </div>
	 <div class="row light-back pump-house-status mock-pump">
 ...
 <div class="col-sm-3 col-xs-3 drill-schedule-not">
                                ...
                                <!-- <textarea rows="2" cols="50" style="width:100%;" name="reasonformanual"><?php echo $res['reasonformanual'];  ?>



                                </textarea>-->

                                <input type="text" class="form-control" style="width:100%;" name="reasonformanual" value="<?php echo $res['reasonformanual'];  ?>"   />
                             ...
                             <div class="col-sm-3 col-xs-3 fro-pro drill-schedule-reason">
                                ...
                                <label class=""><b>Reasons for off</b></label>
                                 ...
                                 <!--<textarea rows="2" cols="50" style="width:100%;" name="reasonforoff"><?php echo $res['reasonforoff'];  ?>
                                ...
                                <input type="text" class="form-control"  style="width:100%;" name="reasonforoff" value="<?php echo $res['reasonforoff'];  ?>"  />
                            	...
                            	<div class="col-sm-4 col-xs-4  auto-on-off">
                                      ...
                                      <!--  {!! Form::text('autoonoff_date', $res['autoonoff_date'], ['class' => 'form-control', 'placeholder' => '']) !!}-->
										<input type="text" name="autoonoff_date" id="autoonoff_date" value="<?php echo $res['autoonoff_date']; ?>" class="form-control">
                                    ...
                                    <div class="col-sm-2 col-xs-2 firesafety-conducted nox-drill-on">
                                        ...
                                        <!--{!! Form::text('next_trail_date', $res['next_trail_date'], ['class' => 'form-control', 'placeholder' => '']) !!}-->

										<input type="text" name="next_trail_date" id="next_trail_date" value="<?php echo $res['next_trail_date']; ?>" class="form-control">
                                   ...
                                   <div class="col-sm-2 col-xs-2 last-mock-drill">
                                     ...
                                     <!--  {!! Form::text('lastmockdrillcondut', $res['lastmockdrillcondut'], ['class' => 'form-control', 'placeholder' => '']) !!}-->
									   <input type="text" name="lastmockdrillcondut" id="lastmockdrillcondut" value="<?php echo $res['lastmockdrillcondut']; ?>" class="form-control">
                       				 </div>
                            ...
                            <!--  </div>
                     		...
                     		<div class="col-sm-12 col-xs-12">-->
                            		 ...
                            		 <div class="col-sm-3 col-xs-3  next-mock-drill-schedule">
                                        ...
                                        <!--{!! Form::text('nextmockdrillconduct', $res['nextmockdrillconduct'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



										<input type="text" name="nextmockdrillconduct" id="nextmockdrillconduct" value="<?php echo $res['nextmockdrillconduct']; ?>" class="form-control">
                     				...
                     				<div class="col-sm-2 col-xs-2 firesafety-conducted water-drainout-schedule">
                                      ...
                                      <!--  {!! Form::text('waterdrainshed', $res['waterdrainshed'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



										<select name="waterdrainshed" id="waterdrainshed"  class="form-control">
                                        	<option value="Monthly" <?php if($res['waterdrainshed'] == 'Monthly') echo "selected='selected'"; ?>>Monthly</option>
                                            <option value="Quarterly" <?php if($res['waterdrainshed'] == 'Quarterly') echo "selected='selected'"; ?>>Quarterly</option>
                                            <option value="Half-yearly" <?php if($res['waterdrainshed'] == 'Half-yearly') echo "selected='selected'"; ?>>Half-yearly</option>
                                            <option value="Yearly" <?php if($res['waterdrainshed'] == 'Yearly') echo "selected='selected'"; ?>>Yearly</option>
                                        </select>
                                    ...
                                    <div class="col-sm-2 col-xs-2 previous-date">
                                       ...
                                       <!-- {!! Form::text('previousdate', $res['previousdate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



										<input type="text" name="previousdate" id="previousdate" value="<?php echo $res['previousdate']; ?>" class="form-control">
                                    ...
                                    <div class="col-sm-2 col-xs-2  firesafety-conducted next-date">
                                         ...
                                         <!--{!! Form::text('nextdate', $res['nextdate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



										 <input type="text" name="nextdate" id="nextdate" value="<?php echo $res['nextdate']; ?>" class="form-control">
...
<div class="col-sm-4 col-xs-4 dewatering-status" style="padding-top:10px;">
     <h5><b>Dewatering Pump</b></h5>
      <div class="col-sm-3 col-xs-3 for-margin-label dewatering-auto">
            <label>Auto</label>
            {!! Form::text('dewaterpumpauto', $res['dewaterpumpauto'], ['class' => 'form-control number', 'id' =>'dewaterauto', 'placeholder' => '']) !!}
          </div>
          <div class="col-sm-3 col-xs-3 for-margin-label dewatering-manual">
            <label>Manual</label>
            {!! Form::text('dewaterpumpmanual', $res['dewaterpumpmanual'], ['class' => 'form-control number', 'id' =>'dewaterman', 'placeholder' => '']) !!}
          </div>
           <div class="col-sm-3 col-xs-3 for-margin-label dewatering-off">
            <label>OFF</label>
           {!! Form::text('dewaterpumpoff', $res['dewaterpumpoff'], ['class' => 'form-control number', 'id' =>'dewateroff', 'placeholder' => '']) !!}
          </div>
          <div class="col-sm-3 col-xs-3 for-margin-label dewatering-not-working">
            <label>Not Working</label>
           {!! Form::text('dewaterpumpnotworking', $res['dewaterpumpnotworking'], ['class' => 'form-control number', 'id' =>'dewaternw', 'placeholder' => '']) !!}
          </div>
      </div>

            <div class="col-sm-5 col-xs-5  group-indication-panel">
                                       <h5><b>Group Indication panel</b></h5>
                        	 			<!--<label class="col-sm-12 col-xs-12" style="padding-left:0px;">Group Indication panel</label>-->
                                       <!-- {!! Form::text('autoonoff_date', old('autoonoff_date'), ['class' => 'form-control', 'placeholder' => '']) !!}-->
									   <div class="col-sm-3 col-xs-3 grouppanelworking">
                                          <label>Working</label> 
                                            {!! Form::text('grind_panel_working', $res['grind_panel_working'], ['class' => 'form-control', 'id' =>'grind_panel_working', 'placeholder' => '']) !!}
                                       </div>
                                       <div class="col-sm-4 col-xs-4 grouppanelnotworking">
                                           <label>Not Working</label> 
                                           {!! Form::text('grind_panel_ntworking', $res['grind_panel_ntworking'], ['class' => 'form-control', 'id' =>'grind_panel_ntworking', 'placeholder' => '']) !!}
                                      </div>
                                       <div class="col-sm-5 col-xs-5 grouppanelreasonworking">
                                            <label>Reason For Not Working</label> 
                                            {!! Form::text('grind_panel_re_ntworking', $res['grind_panel_re_ntworking'], ['class' => 'form-control', 'id' =>'grind_panel_re_ntworking', 'placeholder' => '']) !!}
                                        </div>
                        			</div>          
                    ...
                    <div class="col-sm-4 col-xs-4 auto" style="padding-top:10px;">
                     				...
                     				<div class="col-sm-3 col-xs-3 booster-auto">
                                       ...
                                       {!! Form::text('boosterautopumps', $res['boosterautopumps'], ['class' => 'form-control number boosterClass', 'id'=>'boosterautopumps', 'placeholder' => '']) !!}
                                    ...
                                    <div class="col-sm-3 col-xs-3 firesafety-conducted pumps-in-manual">
                                       ...
                                       {!! Form::text('boostermanualpumps',  $res['boostermanualpumps'], ['class' => 'form-control number boosterClass', 'id'=>'boostermanualpumps', 'placeholder' => '']) !!}
                                    ...
                                    <div class="col-sm-3 col-xs-3 firesafety-conducted pumps-in-off">
                                         ...
                                         {!! Form::text('boosterpumpsoff',  $res['boosterpumpsoff'], ['class' => 'form-control number boosterClass', 'id'=>'boosterpumpsoff', 'placeholder' => '']) !!}
                                     ...
                                     <div class="col-sm-3 col-xs-3 firesafety-conducted pumps-not-working" style="padding-right:0px;">
                                        ...
                                        {!! Form::text('boosterpumpsnotworking',  $res['boosterpumpsnotworking'], ['class' => 'form-control number boosterClass', 'id'=>'boosterpumpsnotworking', 'placeholder' => '']) !!}
                    ...
                    <div class="col-sm-4 col-xs-4 fro-pro booster-pump-not" style="padding-top:10px;">
                                ...
                                <!-- <textarea rows="2" cols="50" style="width:100%;" name="boosterreasonmanual"><?php echo $res['boosterreasonmanual'];  ?>
                                	...
                                	<input type="text" class="form-control" name="boosterreasonmanual" value="<?php echo $res['boosterreasonmanual'];  ?>" />
                            ...
                            <div class="col-sm-4 col-xs-4 fro-pro booster-pump-reason">
                                ...
                                <!-- <textarea rows="2" cols="50" style="width:100%;" name="boosterreasonoff"><?php echo $res['boosterreasonoff'];  ?>
                                ...
                                <input type="text" class="form-control" name="boosterreasonoff" value="<?php echo $res['boosterreasonoff'];  ?>"  /> 
                     				...
                     				<div class="col-sm-5 col-xs-5  auto-on-off">
                        	 			<label class="col-sm-12 col-xs-12" style="padding-left:0px;">Booster Pumps checked on date:</label>
                                      <!--  {!! Form::text('autoonoff_date', $res['autoonoff_date'], ['class' => 'form-control', 'placeholder' => '']) !!}-->
									
										<input type="text" name="boosterchecked_on_date" id="boosterchecked_on_date" value="<?php echo $res['boosterchecked_on_date']; ?>" class="form-control">
                                    ...
                                    <div class="col-sm-3 col-xs-3 firesafety-conducted nox-drill-on">
										...
										<input type="text" name="boostershedule_on_date" id="boostershedule_on_date" value="<?php echo $res['boostershedule_on_date']; ?>" class="form-control">
                   ...
                   <div class="row light-back">
                     <div class="col-sm-12 col-xs-12 firealarm">
                     				...
                     				<!--<div class="col-sm-4 col-xs-4 firesafety-conducted">
                                       ...
                                       {!! Form::text('firealaramsysnum',  $res['firealaramsysnum'], ['class' => 'form-control', 'placeholder' => '']) !!}
                                    ...
                                    <div class="col-sm-1 col-xs-1 working">
                                      ...
                                      {!! Form::text('firealaramsysworking',  $res['firealaramsysworking'], ['class' => 'form-control number fireClass', 'id'=>'firealaramsysworking', 'placeholder' => '']) !!}
                                    </div>
                                    <div class="col-sm-1 col-xs-1 firesafety-conducted not-working">
                                          <label class="col-sm-12 col-xs-12">Not Working</label>
                                         {!! Form::text('firealaramsysnotworking', $res['firealaramsysnotworking'], ['class' => 'form-control number fireClass', 'id'=>'firealaramsysnotworking', 'placeholder' => '']) !!}
                                    </div>
                                     <div class="col-sm-4 col-xs-4 firesafety-conducted reasonnotworkingg">
                                          ...
                                          <input type="text" name="firealaramnotworkingreason" value="<?php echo $res['firealaramnotworkingreason'];  ?>" class="form-control" style="width:100%"  />
                                    </div>
                                 	</div>
                        ...
                        <div class="col-sm-12 col-xs-12 especially-heading">
                        	...
                        	<h4><span><b>FA system Repeater panel</b></span></h4>
							 ...
							 <div class="col-sm-1 col-xs-1 working">
                                <label>Working</label> 
                                {!! Form::text('fasys_panel_working', $res['fasys_panel_working'], ['class' => 'form-control', 'id' =>'fasys_panel_working', 'placeholder' => '']) !!}
                              </div>
                              <div class="col-sm-1 col-xs-1 notworking">
                                <label>Not Working</label> 
                                {!! Form::text('fasys_panel_ntworking', $res['fasys_panel_ntworking'], ['class' => 'form-control', 'id' =>'fasys_panel_ntworking', 'placeholder' => '']) !!}
                              </div>
                              <div class="col-sm-3 col-xs-3 reasonworking">
                                <label>Reason For Not Working</label> 
                                {!! Form::text('fasys_panel_re_ntworking', $res['fasys_panel_re_ntworking'], ['class' => 'form-control', 'id' =>'fasys_panel_re_ntworking', 'placeholder' => '']) !!}
                                </div>
                              ...
                              <div class="col-sm-2 col-xs-2 firesafety-conducted not-working">
                                         ...
                                         {!! Form::text('falsealaram', $res['falsealaram'], ['class' => 'form-control', 'id'=>'falsealaram', 'placeholder' => '', 'onkeyup'=>'falsecount()']) !!}  

                                    </div> 
									
									<div id="remarksblock" class="col-sm-2 col-xs-2 firesafety-conducted false-alarm-reason" style="display:<?php if($res['falsealaram'] > 0) echo 'block;'; else  echo 'none;'; ?>">   

                                          <label class="col-sm-12 col-xs-12">False Alaram Reason</label>

                                         {!! Form::text('falsealaramremarks', $res['falsealaramremarks'], ['class' => 'form-control', 'id'=>'falsealaramremarks', 'placeholder' => '']) !!}
                     ...
                     <div class="col-sm-12 col-xs-12 public-addressing">
                     				...
                     				<!--<div class="col-sm-4 col-xs-4 firesafety-conducted">
                                       ...
                                       {!! Form::text('passystemnum',  $res['passystemnum'], ['class' => 'form-control', 'placeholder' => '']) !!}
                                    ...
                                    <div class="col-sm-1 col-xs-1 working">
                                       ...
                                       {!! Form::text('passystemworking',  $res['passystemworking'], ['class' => 'form-control number paClass', 'id'=>'passystemworking', 'placeholder' => '']) !!}
                                    ...
                                    <div class="col-sm-1 col-xs-1 firesafety-conducted not-working">
                                         ...
                                         {!! Form::text('passystemnotworking',  $res['passystemnotworking'], ['class' => 'form-control number paClass', 'id'=>'passystemnotworking', 'placeholder' => '']) !!}
                                     ...
                                     <div class="col-sm-4 col-xs-4 firesafety-conducted reason-not-working">
                                          ...
                                          <label class="col-sm-12 col-xs-12">Reasons for Not Working</label>
                                           ...
                                           <input type="text" name="passystemreasonnotworking"  value="<?php echo $res['passystemreasonnotworking'];  ?>" class="form-control" style="width:100%"  />
                      ...
                      <div class="row light-back1">
                          <div class="col-sm-12 col-xs-12 system-repeater">
							 ...
							 <div class="col-sm-1 col-xs-1 working">	                                        
                                <label>Working</label> 
                                {!! Form::text('pasys_panel_working', $res['pasys_panel_working'], ['class' => 'form-control', 'id' =>'pasys_panel_working', 'placeholder' => '']) !!}
                             </div>
                              <div class="col-sm-1 col-xs-1 notworking">	
                                <label>Not Working</label> 
                                {!! Form::text('pasys_panel_ntworking', $res['pasys_panel_ntworking'], ['class' => 'form-control', 'id' =>'pasys_panel_ntworking', 'placeholder' => '']) !!}
                                </div>
                                
                                 <div class="col-sm-4 col-xs-4 reasonnotworking">	
                                   <label>Reason For Not Working</label> 
                                   {!! Form::text('pasys_panel_re_ntworking', $res['pasys_panel_re_ntworking'], ['class' => 'form-control', 'id' =>'pasys_panel_re_ntworking', 'placeholder' => '']) !!}
                                 </div>
                           </div>
                         </div>
                     ...
                     <div class="col-sm-12 col-xs-12 carbon-emission">
                     				...
                     				<!--<div class="col-sm-4 col-xs-4 firesafety-conducted">
                                        ...
                                        {!! Form::text('carbonemissionjetfannum',  $res['carbonemissionjetfannum'], ['class' => 'form-control', 'placeholder' => '']) !!}
                                    ...
                                    <div class="col-sm-1 col-xs-1 working">
                                        ...
                                        {!! Form::text('carbonemissionworking',  $res['carbonemissionworking'], ['class' => 'form-control number carClass', 'id'=>'carbonemissionworking', 'placeholder' => '']) !!}
                                    ...
                                    <div class="col-sm-1 col-xs-1 firesafety-conducted not-working">
                                         ...
                                         {!! Form::text('carbonemissionnotworking',  $res['carbonemissionnotworking'], ['class' => 'form-control number carClass', 'id'=>'carbonemissionnotworking', 'placeholder' => '']) !!}
                                     ...
                                     <div class="col-sm-4 col-xs-4 firesafety-conducted reason-not-working">
                                          ...
                                          <label class="col-sm-12 col-xs-12">Reasons for Not Working</label>
                                           ...
                                           <input name="carbonemissreasonnotworking"  value="<?php echo $res['carbonemissreasonnotworking'];  ?>" type="text" class="form-control" style="width:100%"  />
                    ...
                    <div class="col-sm-12 col-xs-12" style="padding-top:10px;">
                                  ...
                                  <div class="col-sm-2 col-xs-2 for-margin-label especially-heading total-percentage">
                                       ...
                                       {!! Form::text('sumpstotnum',  $res['sumpstotnum'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                      ...
                                      {!! Form::text('sumpspresentnum',  $res['sumpspresentnum'], ['class' => 'form-control', 'placeholder' => '']) !!}
                                      ...
                                      <!--{!! Form::text('sumplastcleandate',  $res['sumplastcleandate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



									  	<input type="text" name="sumplastcleandate" id="sumplastcleandate" value="<?php echo $res['sumplastcleandate']; ?>" class="form-control">
...
-->
                                  ...
                                  <div class="col-sm-2 col-xs-2 for-margin-label high-medium">
                                      	...
                                      	<ul>
                                        	...
                                        	<li><input type="radio" name="sumpwaterlevel" value="High" <?php if($res['sumpwaterlevel']== 'High') echo "checked"; ?>>High</li>



                                            <li><input type="radio" name="sumpwaterlevel" value="Medium" <?php if($res['sumpwaterlevel']== 'Medium') echo "checked"; ?>>Medium</li>



                                            <li><input type="radio" name="sumpwaterlevel" value="Low" <?php if($res['sumpwaterlevel']== 'Low') echo "checked"; ?>>Low</li>
											 <li><input type="radio" name="sumpwaterlevel" value="NA" <?php if($res['sumpwaterlevel']== 'NA') echo "checked"; ?>>NA</li>
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label sump-water-total">
                                       ...
                                       {!! Form::text('sumptotwaterlevel',  $res['sumptotwaterlevel'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                       ...
                                       {!! Form::text('sumppresentwaterlevel',  $res['sumppresentwaterlevel'], ['class' => 'form-control', 'placeholder' => '']) !!}
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label sump-water-cleaned">
                                        ...
                                        <!--{!! Form::text('sumpnextcleaningdate',  $res['sumpnextcleaningdate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



											<input type="text" name="sumpnextcleaningdate" id="sumpnextcleaningdate" value="<?php echo $res['sumpnextcleaningdate']; ?>" class="form-control">
                     ...
                     <div class="row light-back oht-water-level">
                      ...
                      <div class="col-sm-12 col-xs-12" style="padding-top:10px;">
                                  ...
                                  <div class="col-sm-2 col-xs-2 for-margin-label especially-heading total-percentage">
                                      ...
                                      {!! Form::text('ohttankstotnum',  $res['ohttankstotnum'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                      ...
                                      {!! Form::text('ohttankspresent',  $res['ohttankspresent'], ['class' => 'form-control', 'placeholder' => '']) !!}
                                     ...
                                     <div class="col-sm-2 col-xs-2 for-margin-label last-cleaned">
                                      ...
                                      <!-- {!! Form::text('ohtlastcleaneddate',  $res['ohtlastcleaneddate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



									   <input type="text" name="ohtlastcleaneddate" id="ohtlastcleaneddate" value="<?php echo $res['ohtlastcleaneddate']; ?>" class="form-control">
...
-->
                                  ...
                                  <div class="col-sm-2 col-xs-2 for-margin-label high-medium">
                                      	...
                                      	<ul>
                                        	...
                                        	<li><input type="radio" name="ohtwaterlevel" value="High" <?php if($res['ohtwaterlevel']== 'High') echo "checked"; ?>>High</li>



                                            <li><input type="radio" name="ohtwaterlevel" value="Medium" <?php if($res['ohtwaterlevel']== 'Medium') echo "checked"; ?>>Medium</li>



                                            <li><input type="radio" name="ohtwaterlevel" value="Low" <?php if($res['ohtwaterlevel']== 'Low') echo "checked"; ?>>Low</li>

                                              <li><input type="radio" name="ohtwaterlevel" value="NA" <?php if($res['ohtwaterlevel']== 'NA') echo "checked"; ?> />NA</li>
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label oht-water-total">
                                       ...
                                       {!! Form::text('totohtwaterlevel',  $res['totohtwaterlevel'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                       ...
                                       {!! Form::text('presentohtwaterlevel',  $res['presentohtwaterlevel'], ['class' => 'form-control', 'placeholder' => '']) !!}
                                      ...
                                      <!-- {!! Form::text('ohtnextcleaningdate',  $res['ohtnextcleaningdate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



									    <input type="text" name="ohtnextcleaningdate" id="ohtnextcleaningdate" value="<?php echo $res['ohtnextcleaningdate']; ?>" class="form-control">
                     ...
                     <div class="col-sm-12 col-xs-12 work-permits">
                                    <div class="col-sm-3 col-xs-3 hot-work-permit">
                                        ...
                                        {!! Form::text('numofworkpermitsissued',  $res['numofworkpermitsissued'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                    </div>
                                    ...
                                    <div class="col-sm-3 col-xs-3 firesafety-conducted general-workpermit">
                                        ...
                                        {!! Form::text('generalworkpermitsnum',  $res['generalworkpermitsnum'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                    </div>
                              ...
                              {!! Form::text('electricalworkpermitsissued',  $res['electricalworkpermitsissued'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                 </div>
                                      ...
                                      <div class="col-sm-3 col-xs-3 firesafety-conducted height-workpermit">
                                       ...
                                       {!! Form::text('heightworkpermitsissued',  $res['heightworkpermitsissued'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                    </div>
								   ...
								   <div class="col-sm-3 col-xs-3 entry-workpermit">
                                       ...
                                       {!! Form::text('veshtlpermitsissued', $res['veshtlpermitsissued'], ['class' => 'form-control number', 'placeholder' => '']) !!}
                                    </div>
                        ...
                        <div class="col-sm-2 col-xs-2 co2-fire">
                                 ...
                                 <!-- <div class="col-sm-6 col-xs-6 for-margin-label especially-heading">
                                      ...
                                      <div class="col-sm-12 col-xs-12 fro-pro">
                                       ...
                                       {!! Form::text('co2firenotworking',  $res['co2firenotworking'], ['class' => 'form-control number', 'id'=>'co2firenotworking','placeholder' => '']) !!}
                                ...
                                <div class="col-sm-2 col-xs-2 firesafety dcp-fire">
                                  ...
                                  <!--<div class="col-sm-6 col-xs-6 for-margin-label especially-heading">
                                      ...
                                      <div class="col-sm-12 col-xs-12 fro-pro">
                                       ...
                                       {!! Form::text('dcpfirenotworking',  $res['dcpfirenotworking'], ['class' => 'form-control number', 'id'=>'dcpfirenotworking', 'placeholder' => '']) !!}
                                ...
                                <div class="col-sm-2 col-xs-2 firesafety water-fire">
                                 ...
                                 <!-- <div class="col-sm-6 col-xs-6 for-margin-label especially-heading">
                                      ...
                                      {!! Form::text('waterfirenotworking',  $res['waterfirenotworking'], ['class' => 'form-control number', 'id'=>'waterfirenotworking', 'placeholder' => '']) !!}
                                ...
                                <div class="col-sm-2 col-xs-2 firesafety refilling-inspection">



                           <?php /*?>       <h5><b>Next Refilling</b></h5>



                                  <div class="col-sm-6 col-xs-6 for-margin-label especially-heading refilling">
                                        ...
                                        <!--{!! Form::text('refillingdate',  $res['refillingdate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



										<input type="text" name="refillingdate" id="refillingdate" value="<?php echo $res['refillingdate']; ?>" class="form-control">
                                     ...
                                     <!--  {!! Form::text('inspectiondate',  $res['inspectiondate'], ['class' => 'form-control', 'placeholder' => '']) !!}-->



									   <input type="text" name="inspectiondate" id="inspectiondate" value="<?php echo $res['inspectiondate']; ?>" class="form-control">
...
<div class="row light-back1">  
  <div class="col-sm-12 mmr-firesafetyreport">                    
    <div class="col-sm-12 col-xs-12">
        ...
        <input type="text" class="form-control <?php if($res['firesafety_major_ac'] == "") echo 'validres'; ?>" name="firesafety_major_ac" value="<?php echo $res['firesafety_major_ac'];  ?>"  />
    </div> 
  </div>
</div>
