              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div>
                  ...
                  <div class="row x_title" style="border-bottom:none;margin-bottom:0px;padding-bottom:0px;">
                     <span class="col-sm-6 col-xs-6" style="font-weight:bold;font-size:19px;color:#000;">APMS-<?php echo get_sitename($sitefilter);?> </span>
                        <div class="col-sm-6 col-xs-6 date">SECURITY | DATE: <?php echo $datefilter;?> | TIME: <?php date_default_timezone_set('Asia/Kolkata'); echo date("h:i:sa"); $pemsresv = getdefaultpmstot($sitefilter); ?></div>
                     ...
                     <table width="100%" border="1" style="text-align:left;">
                     	<tbody style="border:1px solid #000;">
                        	<tr style="text-align:left;">
                                ...
                                <th><p>Lady Guard</p></th>
                                <th><p>Head Guard</p></th>
                                <th class="text-center">SUP</th>
                                <th class="text-center">A.S.O</th>
                        	...
                        	<tr>
                                ...
                                <td><p><b>Transfer from other sites</b></p></td>
                            ...
                            <tr>
                                ...
                                <td><p><b>Transfer to other sites</b></p></td>
                        ...
                        <tr>
                          ...
                          <!-- </tbody>
                           ...
                           <tbody style="border:1px solid #000;">-->
                            ...
                            <tr>
                            	<td rowspan="1" class="text-center"><b>10</b></td>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td><b>ID Cards.</b></td>
                                 <td class="text-center"><span><?php if(isset($res['aw_maid']))echo $res['aw_maid']; ?>/<?php echo $res['id_maid'];?></span></td>
                                <td class="text-center"><span><?php if(isset($res['aw_dri']))echo $res['aw_dri']; ?>/<?php echo $res['id_dri'];?></span></td>
                                 <td class="text-center"><span><?php if(isset($res['aw_ven']))echo $res['aw_ven']; ?>/<?php echo $res['id_ven'];?></span></td>
                                 <td colspan="2" class="text-center"><span><?php if(isset($res['aw_inte']))echo $res['aw_inte']; ?>/<?php echo $res['id_inte'];?></span></td>
                                 <td class="text-center"><span><?php if(isset($res['aw_others']))echo $res['aw_others']; ?>/<?php echo $res['id_others'];?></span></td>
                            ...
                            <tr>
                               ...
                               <td class="white-spacing"><p><b>BY.</b> <span><?php if(isset($res['night_check_by']))echo $res['night_check_by']; ?></span></p></td>
                            </tr>
                            <tr>
