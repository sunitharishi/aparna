...
<!-------------------------------------------land-scaping---------------------------------------->
                    ...
                    <div class="col-sm-12 col-xs-12 land-scaping"> 
                    	...
                    	<div class="col-sm-3 col-xs-3 fro-pro land-attendance">
                            ...
                            <div class="col-sm-4 col-xs-4 fro-pro sup">
                                  ...
                                  {!! Form::text('land_atten_sup', old('land_atten_sup'), ['class' => 'form-control number', 'id'=>'land_atten_sup', 'placeholder' => '']) !!}
                            ...
                            <div class="col-sm-4 col-xs-4">
                                 ...
                                 {!! Form::text('land_atten_helper', old('land_atten_helper'), ['class' => 'form-control number', 'id'=>'land_atten_helper', 'placeholder' => '']) !!}
                        ...
                        <div class="col-sm-3 col-xs-3 fro-pro watering-time">
                            ...
                            <div class="col-sm-4 col-xs-4 watering">
                                  ...
                                  {!! Form::text('land_water_qty', old('land_water_qty'), ['class' => 'form-control number', 'placeholder' => 'KL']) !!}
                            </div>
                            <div class="col-sm-4 col-xs-4 time">
                                  <label class="col-sm-12 col-xs-12">Time</label>
								  {!! Form::text('land_water_time', old('land_water_time'), ['class' => 'form-control timepicker', 'placeholder' => '']) !!}
                            </div>
                        </div>
                          <div class="col-sm-5 col-xs-5 fro-pro extra-activities">
                            ...
                            <div class="col-sm-3 col-xs-3 fro-pro">
                                  <label class="col-sm-12 col-xs-12 loc-time">Multching</label>
                                   {!! Form::text('extra_act_multching', old('extra_act_multching'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
                            <div class="col-sm-3 col-xs-3 cleaning" style="padding-right:0px;">
                                  <label class="col-sm-12 col-xs-12">Gap filling</label>
                                   {!! Form::text('extra_act_gap_filling', old('extra_act_gap_filling'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
							<div class="col-sm-3 col-xs-3 cleaning" style="padding-right:0px;">
                                  <label class="col-sm-12 col-xs-12">Staking</label>
                                   {!! Form::text('extra_act_gap_staking', old('extra_act_gap_staking'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
                        </div>
					  ...
					  <div class="col-sm-3 col-xs-3 fro-pro power-point">
                            ...
                            <div class="col-sm-6 col-xs-6 fro-pro">
                                  <label class="col-sm-12 col-xs-12 loc-time">Not Working</label>
                                   {!! Form::text('power_point_nw', old('power_point_nw'), ['class' => 'form-control', 'onchange'=>'checknwvalvevalidate(this,this.value,"power_point_nw")','placeholder' => '']) !!}
                            </div>
                      </div>
					  
					   
					       <div class="col-sm-3 col-xs-3 fro-pro solonide-values">
                    		<label class="control-label col-sm-5 col-xs-5 text-right values"><b>Solonide Valves:</b></label>
                            <div class="col-sm-4 col-xs-4 fro-pro not-working">
                                  <label class="col-sm-12 col-xs-12 loc-time">Not Working</label>
                                   {!! Form::text('solonide_valve_nw', old('solonide_valve_nw'), ['class' => 'form-control', 'id'=>'solonide_valve_nw', 'onchange'=>'checknwvalvevalidate(this,this.value,"solonide_valve_nw")', 'placeholder' => '']) !!}
                            </div>
                      </div>  
                    ...
                    <div class="col-sm-3 col-xs-3 fro-pro quick-coupling-values">
                            ...
                            <div class="col-sm-5 col-xs-5 fro-pro">
                                  <label class="col-sm-12 col-xs-12 loc-time">Not Working</label>
                                   {!! Form::text('quick_couple_nw', old('quick_couple_nw'), ['class' => 'form-control', 'onchange'=>'checknwvalvevalidate(this,this.value,"quick_couple_nw")', 'placeholder' => '']) !!}
                            </div>
                      </div>
                        ...
                        <!--<div class="col-sm-3 col-xs-3 fro-pro cleaning-location">
                            ...
                            <div class="col-sm-4 col-xs-4 fro-pro">
                                  <label class="col-sm-12 col-xs-12 loc-time">Time</label>
                                   {!! Form::text('land_clean_time', old('land_clean_time'), ['class' => 'form-control timepicker', 'placeholder' => '']) !!}
                            </div>
                            <div class="col-sm-4 col-xs-4 cleaning" style="padding-right:0px;">
                                  <label class="col-sm-12 col-xs-12">Location</label>
                                   {!! Form::text('land_clean_location', old('land_clean_location'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
                        </div>-->
                        ...
                        <div class="col-sm-2 col-xs-2 fro-pro sprinkler-not-working">
                            ...
                            <div class="col-sm-7 col-xs-7 fro-pro not-sprinklers">
                                ...
                                {!! Form::text('land_clean_sprinknw', old('land_clean_sprinknw'), ['class' => 'form-control number', 'id'=>'land_clean_sprinknw', 'placeholder' => '']) !!}
                            </div>
                         </div>
                        ...
                        <div class="col-sm-3 col-xs-3 spraying-locations">
                                ...
                                <div class="locationmem">
                                  ...
                                  {!! Form::text('land_spray_location', old('land_spray_location'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}
                                  {!! Form::text('land_spray_mem', old('land_spray_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                                  </div>
                            ...
                            <div class="col-sm-3 col-xs-3 fro-pro weeding-locations">
                                  ...
                                  <label>Lawn Edge Cutting: </label>
                                   ...
                                   {!! Form::text('land_Weeding_location', old('land_Weeding_location'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}

                                    {!! Form::text('land_Weeding_memcn', old('land_Weeding_memcn'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                                  </div>
                           ...
                           <div class="col-sm-3 col-xs-3 fro-pro mowing-locations">
								...
								<div class="locationmem">
                                 {!! Form::text('land_mowing_location', old('land_mowing_location'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}



								 {!! Form::text('land_mowing_memcn', old('land_mowing_memcn'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                             ...
                             <div class="col-sm-3 col-xs-3 fro-pro application">
                                 ...
                                 <div class="locationmem">
                                  {!! Form::text('land_application', old('land_application'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                    {!! Form::text('land_application_mem', old('land_application_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                             ...
                             <div class="col-sm-3 col-xs-3 mulching">
                                ...
                                <!-- {!! Form::text('land_mulching', old('land_mulching'), ['class' => 'form-control', 'placeholder' => '']) !!}-->



								    <div class="locationmem">
                                  
                                  {!! Form::text('land_mulching', old('land_mulching'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                    {!! Form::text('land_mulching_mem', old('land_mulching_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                           ...
                           <!--  {!! Form::text('land_trimming', old('land_trimming'), ['class' => 'form-control', 'placeholder' => '']) !!}-->


							 <div class="locationmem">
                                  
                                  {!! Form::text('land_trimming', old('land_trimming'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                    {!! Form::text('land_trimming_mem', old('land_trimming_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                            ...
                            <!--     {!! Form::text('land_cutting', old('land_cutting'), ['class' => 'form-control', 'placeholder' => '']) !!}-->


                                  {!! Form::text('land_cutting', old('land_cutting'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                    {!! Form::text('land_cutting_mem', old('land_cutting_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                             ...
                             <div class="col-sm-3 col-xs-3 fro-pro pruning">
                                ...
                                <div class="locationmem">
                                 ...
                                 {!! Form::text('land_pruning', old('land_pruning'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                {!! Form::text('land_pruning_mem', old('land_pruning_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                                </div>
                             ...
                             <div class="col-sm-3 col-xs-3  shaping">
                               ...
                               <!-- {!! Form::text('land_shaping', old('land_shaping'), ['class' => 'form-control', 'placeholder' => '']) !!}-->

                                <div class="locationmem">


                                 {!! Form::text('land_shaping', old('land_shaping'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                {!! Form::text('land_shaping_mem', old('land_shaping_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                                </div>
                             ...
                             <div class="col-sm-3 col-xs-3 fro-pro hoeing-locations">
                                ...
                                <!--  {!! Form::text('land_hoeing', old('land_hoeing'), ['class' => 'form-control', 'placeholder' => '']) !!}-->
                                  
                                     <div class="locationmem">


                                 {!! Form::text('land_hoeing', old('land_hoeing'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                {!! Form::text('land_hoeing_mem', old('land_hoeing_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                                </div>
                            ...
                            <div class="col-sm-3 col-xs-3 fro-pro garden">
								...
								<!--{!! Form::text('land_garden_waste', old('land_garden_waste'), ['class' => 'form-control', 'placeholder' => '']) !!}-->
                                 <div class="locationmem">
                                
                                 {!! Form::text('land_garden_waste', old('land_garden_waste'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                {!! Form::text('land_garden_waste_mem', old('land_garden_waste_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                                </div>
                            </div>
                              ...
                              <div class="col-sm-3 col-xs-3 fro-pro extra">
                            	<label class="control-label col-sm-12 col-xs-12">Extra Activities:</label>
                                 <div class="locationmem">
								<!--{!! Form::text('land_extra_activity', old('land_extra_activity'), ['class' => 'form-control', 'placeholder' => '']) !!}-->
                                  {!! Form::text('land_extra_activity', old('land_extra_activity'), ['class' => 'form-control memcn', 'placeholder' => 'Location']) !!}


                                {!! Form::text('land_extra_activity_mem', old('land_extra_activity_mem'), ['class' => 'form-control', 'placeholder' => 'count']) !!}
                                </div>
...
<!-------------------------------------------house-keeping---------------------------------------->
                              ...
                              <div class="col-sm-12 col-xs-12  fro-pro1">
                                 ...
                                 <div class="col-sm-3 col-xs-3 house-attendance">
                            	    ...
                            	    <div class="col-sm-4 col-xs-4 sup">
                                  	 ...
                                  	 {!! Form::text('housekp_atten_sup', old('housekp_atten_sup'), ['class' => 'form-control number', 'id'=>'housekp_atten_sup', 'placeholder' => '']) !!}
                            	  </div>
                                  <div class="col-sm-4 col-xs-4 helper"> 
                                    <label for="Helpers">Helper</label>
                                    {!! Form::text('housekp_atten_helper', old('housekp_atten_helper'), ['class' => 'form-control number', 'id'=>'housekp_atten_helper', 'placeholder' => '']) !!}
                                </div>
                             </div>
                        ...
                        <div class="col-sm-3 col-xs-3 fro-pro house-ride-on">
                    			 	<label class="control-label col-sm-4 col-xs-4 text-right" style="margin-top:28px;padding-right:6px;"><b>Ride on:</b></label>
                            	 <div class="col-sm-4 col-xs-4 sup hrs-run">
                                  	<label for="sup" >Hrs Run</label>
                                  	 {!! Form::text('housekp_rideon_hrs', old('housekp_rideon_hrs'), ['class' => 'form-control timepicker', 'placeholder' => '']) !!}
                            	</div>
                                <div class="col-sm-4 col-xs-4 location">
                                  <label for="Helpers">Location</label>
                                   {!! Form::text('housekp_location', old('housekp_location'), ['class' => 'form-control', 'placeholder' => '']) !!}
                              </div>
                        </div>
                         ...
                         <div class="col-sm-3 col-xs-3 fro-pro Scrubbing">
                            	 ...
                            	 <div class="col-sm-4 col-xs-4 sup hrs-run">
                                  	<label for="sup" >Hrs Run</label>
									{!! Form::text('scrub_hrs_run', old('scrub_hrs_run'), ['class' => 'form-control timepicker', 'placeholder' => '']) !!}
                            	</div>
                                <div class="col-sm-4 col-xs-4 location">
                                  <label for="Helpers">Location</label>
								  {!! Form::text('scrub_location', old('scrub_location'), ['class' => 'form-control', 'placeholder' => '']) !!}
                              </div>
                        </div>
                           ...
                           <div class="col-sm-3 col-xs-3 fro-pro fogging">
                            	 ...
                            	 <div class="col-sm-4 col-xs-4 sup hrs-run">
                                  	<label for="sup" >Hrs Run</label>
									{!! Form::text('fogg_hrs_run', old('fogg_hrs_run'), ['class' => 'form-control timepicker', 'placeholder' => '']) !!}
                            	</div>
                                <div class="col-sm-4 col-xs-4 location">
                                  <label for="Helpers">Location</label>
								  {!! Form::text('fogg_location', old('fogg_location'), ['class' => 'form-control', 'placeholder' => '']) !!}
                              </div>
                        </div>
                        ...
                        <div class="col-sm-3 col-xs-3 debris">
                                  ...
                                  <div class="col-sm-4 col-xs-4">
                                  	<label class="col-sm-12 col-xs-12" style="padding:0px;">No. of Trips </label>
                                  	 {!! Form::text('housekp_debr_tipsnum', old('housekp_debr_tipsnum'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            	</div>
                            <div class="col-sm-4 col-xs-4" style="padding-right:0px;">
                                  <label class="col-sm-12 col-xs-12" style="padding:0px;">Vol (CFT) </label>
                                   {!! Form::text('housekp_debr_vol', old('housekp_debr_vol'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3 col-xs-3  garbage">
                            ...
                            <div class="col-sm-8 col-xs-8 fro-pro out-time">
                                ...
                                {!! Form::text('housekp_debr_garbage', old('housekp_debr_garbage'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
                        </div>
                         ...
                         <div class="col-sm-3 col-xs-3 thefts">
                            <label class="col-sm-12 col-xs-12">Thefts:</label>
                                 {!! Form::text('housekp_thefts', old('housekp_thefts'), ['class' => 'form-control', 'placeholder' => '']) !!}
                        </div>
                         ...
                         <div class="col-sm-3 col-xs-3 fro-pro violations-noticed">
                            ...
                            <div class="col-sm-12 col-xs-12 fro-pro">
                                  ...
                                  {!! Form::text('housekp_violation_notice', old('housekp_violation_notice'), ['class' => 'form-control', 'placeholder' => '']) !!}
                         ...
                         <div class="col-sm-3 col-xs-3 areas-inspected" style="padding-right:0px;">
                            ...
                            <div class="col-sm-12 col-xs-12 fro-pro">
                                    ...
                                    {!! Form::text('housekp_area_inspect', old('housekp_area_inspect'), ['class' => 'form-control', 'placeholder' => '']) !!}
						...
						<div class="col-sm-3 col-xs-3 areas-inspected pest" style="padding-right:0px;">
                            ...
                            <div class="col-sm-12 col-xs-12 fro-pro" style="padding-right:0px;">
                                    ...
                                    {!! Form::text('housekp_pest', old('housekp_pest'), ['class' => 'form-control', 'placeholder' => '']) !!}
                       ...
                       <div class="col-sm-6 col-xs-6 pest-remark">
                            ...
                            <div class="col-sm-12 col-xs-12 fro-pro" style="padding-right:0px;">
                                      {!! Form::text('housekp_remarks', old('housekp_remarks'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
...
<!-------------------------------------------club-house------------------------------------------->                           
                              ...
                              <div class="col-sm-12 col-xs-12">
                                 ...
                                 <div class="col-sm-6 col-xs-6 fro-pro club-house-attendance">
                            	   ...
                            	   <div class="col-sm-3 col-xs-3 sup">
                                  	<label class="col-sm-12 col-xs-12">Front Office </label>
                                  	 {!! Form::text('clbhous_att_frntofc', old('clbhous_att_frntofc'), ['class' => 'form-control number', 'id'=>'clbhous_att_frntofc', 'placeholder' => '']) !!}
                            	  </div>
                                    <div class="col-sm-3 col-xs-3 house-keeping">
                                          <label class="col-sm-12 col-xs-12">House Keeping</label>
                                           {!! Form::text('clbhous_att_housekp', old('clbhous_att_housekp'), ['class' => 'form-control number', 'id'=>'clbhous_att_housekp', 'placeholder' => '']) !!}
                                    </div>
                                    <div class="col-sm-2 col-xs-2 cum" style="padding-right:0px;">
                                         <label class="col-sm-12 col-xs-12">Supervisor:</label>
                                          {!! Form::text('supervisor', old('supervisor'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                                   </div>
                                     <div class="col-sm-2 col-xs-2 others">
                                         <label class="col-sm-12 col-xs-12">Others</label>
                                         {!! Form::text('clbhous_att_other', old('clbhous_att_other'), ['class' => 'form-control number', 'id'=>'clbhous_att_other', 'placeholder' => '']) !!}
                                    </div>
                                </div>
                                 ...
                                 <div class="col-sm-4 col-xs-4 fro-pro revenue">
                            	    ...
                            	    <div class="col-sm-3 col-xs-3 sup day">
                                  		<label class="col-sm-12 col-xs-12">Day: </label>
                                  		 {!! Form::text('clbhous_revenue_day', old('clbhous_revenue_day'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                            		</div>
									<div class="col-sm-5 col-xs-5 cum" style="padding-right:0px;">
                                  		<label class="col-sm-12 col-xs-12">Commercial Activite:</label>
                                  		 {!! Form::text('commercial_activate', old('commercial_activate'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            		</div>
                                 </div>
                            		...
                            		<!--<div class="col-sm-4 col-xs-4 cum" style="padding-right:0px;">
                                  		...
                                  		<label class="col-sm-12 col-xs-12">Cum:</label>
                                  		 ...
                                  		 {!! Form::text('clbhous_revenue_cum', old('clbhous_revenue_cum'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                                 ...
                                 <div class="col-sm-2 col-xs-2 total-application power">
                                    ...
                                    <div class="col-sm-7 col-xs-7 sup total-application" style="padding-right:0px;">
                                	   ...
                                	   {!! Form::text('clbhous_pwr_units', old('clbhous_pwr_units'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                            	 ...
                            	 <div class="col-sm-2 col-xs-2 sup gym">
                                  	...
                                  	<label for="sup">Gym: </label>
                                  	 ...
                                  	 {!! Form::text('clbhous_users_gym', old('clbhous_users_gym'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                            ...
                            <div class="col-sm-2 col-xs-2 pool">
                                  ...
                                  <label for="Helpers">Pool:</label>
                                   ...
                                   {!! Form::text('clbhous_users_pool', old('clbhous_users_pool'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                             ...
                             <div class="col-sm-2 col-xs-2 tennis">
                                  ...
                                  <label for="Helpers">Tennis:</label>
                                   ...
                                   {!! Form::text('clbhous_users_tennis', old('clbhous_users_tennis'), ['class' => 'form-control number', 'placeholder' => '']) !!}
							 ...
							 <div class="col-sm-2 col-xs-2 tennis">
                                  ...
                                  <label for="Helpers">Shuttle:</label>
                                   ...
                                   {!! Form::text('clbhous_shuttle', old('clbhous_shuttle'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                         ...
                         <div class="col-sm-7 col-xs-7 fro-pro club-house-remarks">
                                  <label>Remarks </label>
                                    ...
                                    {!! Form::text('clbhous_users_remarks', old('clbhous_users_remarks'), ['class' => 'form-control', 'placeholder' => '']) !!}
...
<!-------------------------------------------apna-complex(apms)------------------------------------>
                                 ...
                                 <!-- <div class="col-sm-10 col-xs-10">-->
                                  ...
                                  <div class="col-sm-1 col-xs-1 for-margin-label complex-previous">
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label complax-help-desk">
                                        ...
                                        {!! Form::text('apna_apms_opened_help', old('apna_apms_opened_help'), ['class' => 'form-control number', 'id' =>'apna_apms_opened_help', 'onchange' =>'getvalidsum()' ,'placeholder' => 'Help Desk']) !!}
                                      ...
                                      <div class="col-sm-1 col-xs-1 for-margin-label complex-login">
                                         ...
                                         {!! Form::text('apna_apms_opened_login', old('apna_apms_opened_login'), ['class' => 'form-control number', 'id' =>'apna_apms_opened_login', 'onchange' =>'getvalidsum()' ,'placeholder' => 'Login']) !!}
                          ...
                          {!! Form::text('apna_apms_opened_total', old('apna_apms_opened_total'), ['class' => 'form-control number', 'id' => 'apna_apms_opened_total', 'placeholder' => 'Total','readonly' => 'true']) !!}
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label complex-resolved">
                                        ...
                                        {!! Form::text('apna_apms_resolved', old('apna_apms_resolved'), ['class' => 'form-control number', 'id'=>'apna_apms_resolved', 'onchange'=>'apmsresol()', 'placeholder' => '']) !!}
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label complex-pending">
                                        ...
                                        {!! Form::text('apna_apms_pending', old('apna_apms_pending'), ['class' => 'form-control number', 'id'=>'apna_apms_pending', 'readonly' => 'true', 'placeholder' => '']) !!}
                             ...
                             <div class="col-sm-6 col-xs-6 fro-pro complex-remarks">
                                  ...
                                  {!! Form::text('apna_apms_remarks', old('apna_apms_remarks'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            ...
                            <div class="row light-back">
                             ...
                             <div class="col-sm-12 col-xs-12 apna-project">
                                  ...
                                  <div class="col-sm-1 col-xs-1 for-margin-label previous">
                                      ...
                                      <div class="col-sm-3 col-xs-3 for-margin-label">
                                        ...
                                        {!! Form::text('apna_project_opened_help', old('apna_project_opened_help'), ['class' => 'form-control number', 'id' =>'apna_project_opened_help', 'onchange' =>'getvalidsumpro()', 'placeholder' => 'Help Desk']) !!}
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label project-login">
                                        ...
                                        {!! Form::text('apna_project_opened_login', old('apna_project_opened_login'), ['class' => 'form-control number', 'id' =>'apna_project_opened_login', 'onchange' =>'getvalidsumpro()', 'placeholder' => 'Login']) !!}
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label project-total">
                                         ...
                                         {!! Form::text('apna_project_opened_total', old('apna_project_opened_total'), ['class' => 'form-control number', 'id' => 'apna_project_opened_total','placeholder' => 'Total','readonly' => 'true']) !!}
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label project-resolved">
                                        ...
                                        {!! Form::text('apna_project_resolved',  old('apna_project_resolved'), ['class' => 'form-control number', 'id'=>'apna_project_resolved', 'onchange'=>'proresol()', 'onchange'=>'proresol()', 'placeholder' => '']) !!}
                                      ...
                                      <div class="col-sm-2 col-xs-2 for-margin-label project-pending">
                                        ...
                                        {!! Form::text('apna_project_pending', old('apna_project_pending'), ['class' => 'form-control number', 'id'=>'apna_project_pending', 'placeholder' => '','readonly' => 'true']) !!}
                             ...
                             <div class="col-sm-6 col-xs-6 fro-pro project-remarks">
                                  ...
                                  <label>Remarks </label>
                                   ...
                                   {!! Form::text('apna_project_remarks', old('apna_project_remarks'), ['class' => 'form-control', 'placeholder' => '']) !!}
...
<!-------------------------------------------occupancy---------------------------------------------->
                            ...
                            <div class="col-sm-2 col-xs-2 occupancy-moved-in">
                                  ...
                                  <h6><b>Moved in</b></h6>
                                      ...
                                      <div class="col-sm-6 col-xs-6 sup especially-heading">
                                  		...
                                  		<label style="font-size:12px;margin-bottom:0px;">Owners </label>
                                  		 ...
                                  		 {!! Form::text('occupancy_move_owners', old('occupancy_move_owners'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                                      ...
                                      <div class="col-sm-6 col-xs-6 for-margin-label">
                                         ...
                                         {!! Form::text('occupancy_move_tenants', old('occupancy_move_tenants'), ['class' => 'form-control', 'placeholder' => '']) !!}
                                ...
                                <div class="col-sm-2 col-xs-2 fro-pro occupancy-vacated">
                                  ...
                                  <div class="col-sm-6 col-xs-6 for-margin-label especially-heading">
                                         ...
                                         {!! Form::text('occupancy_vacated_owners', old('occupancy_vacated_owners'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                                      ...
                                      <div class="col-sm-6 col-xs-6 for-margin-label">
                                        ...
                                        {!! Form::text('occupancy_vacated_tenants', old('occupancy_vacated_tenants'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            ...
                            <div class="col-sm-3 col-xs-3 fro-pro occupancy-as-on-date">
                                  ...
                                  <div class="col-sm-4 col-xs-4 for-margin-label especially-heading">
                                        ...
                                        {!! Form::text('occupancy_asdate_owners', old('occupancy_asdate_owners'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                                      ...
                                      <div class="col-sm-4 col-xs-4 for-margin-label tenants">
                                         ...
                                         {!! Form::text('occupancy_asdate_tenants', old('occupancy_asdate_tenants'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                                      ...
                                      <div class="col-sm-4 col-xs-4 for-margin-label vacant">
                                         ...
                                         {!! Form::text('occupancy_asdate_vacant', old('occupancy_asdate_vacant'), ['class' => 'form-control number', 'placeholder' => '']) !!}
                                 ...
                                 <div class="col-sm-5 col-xs-5 fro-pro occupancy-remarks">
                                  ...
                                  <div class="nbsp">&nbsp;</div>
                                    ...
                                    {!! Form::text('occupancy_asdate_remarks', old('occupancy_asdate_remarks'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            ...
                            <div class="row light-back">
                                ...
                                <div class="col-sm-2 col-xs-2 cash-on-hand">
                                  ...
                                  <label class="control-label col-sm-12" for="pwd">Cash on Hand (<i class="fa fa-inr" aria-hidden="true"></i>)</label>
								    ...
								    {!! Form::text('imprest_cash_on_hand', old('imprest_cash_on_hand'), ['class' => 'form-control', 'placeholder' => '']) !!}
                                ...
                                <div class="col-sm-2 col-xs-2 fro-pro2 bills-on-hands">
                                  ...
                                  <label class="control-label col-sm-12" for="pwd">Bills on Hand (<i class="fa fa-inr" aria-hidden="true"></i>)</label>
                                   ...
                                   {!! Form::text('imprest_bills_on_hand', old('imprest_bills_on_hand'), ['class' => 'form-control', 'placeholder' => '']) !!}
                             ...
                             <div class="col-sm-2 col-xs-2 fro-pro1 date-of-statement">
                                 ...
                                 <div class="col-sm-1 col-xs-1">
                                      ...
                                      <!--<input type="text" class="form-control"  />-->
									   ...
									   {!! Form::text('dateof_statement_amount', old('dateof_statement_amount'), ['class' => 'form-control', 'placeholder' => '']) !!}
                                 ...
                                 <div class="col-sm-1 col-xs-1">
                                      ...
                                      <!--<input type="text" class="form-control"  />-->
									   ...
									   {!! Form::text('dateof_statement_amount_2', old('dateof_statement_amount_2'), ['class' => 'form-control', 'placeholder' => '']) !!}
...
<!-------------------------------------------gas-------------------------------------------------->  
                            ...
                            <div class="row light-back1">
                                ...
                                <div class="col-sm-2 col-xs-2 transaction-by">
                                  ...
                                  {!! Form::text('gas_transact_supervise_by', old('gas_transact_supervise_by'), ['class' => 'form-control', 'placeholder' => '']) !!}
								...
								<div class="col-sm-1 col-xs-1 transaction-by">
                                  ...
                                  {!! Form::text('gas_transact_socity', old('gas_transact_socity'), ['class' => 'form-control', 'placeholder' => '']) !!}
								...
								<div class="col-sm-1 col-xs-1 transaction-by">
                                  ...
                                  {!! Form::text('gas_transact_security', old('gas_transact_security'), ['class' => 'form-control', 'placeholder' => '']) !!}
                                ...
                                <div class="col-sm-2 col-xs-2 fro-pro2 full-cycle">
                                  ...
                                  <label class="control-label col-sm-12" for="pwd">Full Cyl. Recd</label>
                                   ...
                                   {!! Form::text('gas_transact_full_cyl_recd', old('gas_transact_full_cyl_recd'), ['class' => 'form-control', 'placeholder' => '']) !!}
                             ...
                             <div class="col-sm-2 col-xs-2 fro-pro1 empty-cycle">
                                  <label class="control-label col-sm-12" for="email">Empty Cyl. Taken Out</label>
                                   {!! Form::text('gas_empty_cyl_taken_out', old('gas_empty_cyl_taken_out'), ['class' => 'form-control', 'placeholder' => '']) !!}
                             </div>
                         </div>
                     </div>
<!-------------------------------------------gas-------------------------------------------------->  
<!-------------------------------------------information------------------------------------------>                                  
                                ...
                                <div class="col-sm-2 col-xs-2 fro-pro2 data-sheet-pending">
                                  <label class="control-label col-sm-12" for="pwd">Data Sheets Pending</label>
                                    {!! Form::text('info_attend_datesheet_pend', old('info_attend_datesheet_pend'), ['class' => 'form-control', 'placeholder' => '']) !!}
                               </div> 
                             <div class="col-sm-2 col-xs-2 fro-pro1 parking-display">
                                  <label class="control-label col-sm-12" for="email">Parking Display Pending</label>
                                    {!! Form::text('info_parking_display', old('info_parking_display'), ['class' => 'form-control', 'placeholder' => '']) !!}
                                </div>
                                </div>
                            </div>
                            </div>
                              ...
                              <div class="row light-back1">
                                 <div class="col-sm-12 col-xs-12">
                                 	<div class="col-sm-12 col-xs-12 job-pending">
                                		 {!! Form::text('jobs_pending', old('jobs_pending'), ['class' => 'form-control', 'placeholder' => '']) !!}
                                    </div>
                                </div>
                             </div>
<!-------------------------------------------jon-pending------------------------------------------> 
                             ...
                             <div class="row light-back">
                                 <div class="col-sm-12 col-xs-12 ">
                                 	<div class="col-sm-12 col-xs-12 communication">
                                		 {!! Form::text('comminication_with_mc', old('comminication_with_mc'), ['class' => 'form-control', 'placeholder' => '']) !!}
                                    </div>
                                </div>
                            </div>
<!-------------------------------------------communication-with-----------------------------------> 
