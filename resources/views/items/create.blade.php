...
@section('content')
  <!--  <h3 class="page-title">Vendors</h3>-->
    {!! Form::open(['files' => 'true','method' => 'POST', 'route' => ['items.store']]) !!}
        ...
        <div class="panel-body items-creations items-edit class-ctration">
			 <div class="row">
                <div class="col-xs-12 form-group vensor-assets specsific-eselction" id="assetdiv"> 
                    ...
                    {!! Form::select('itemcategory', $category, '', ['class' => 'form-control select2mes', 'id' => 'itemcategory','onchange'=>'getsubCatRecords(this.value)']) !!}
				...
				<div class="col-xs-12 form-group vensor-assets" id="subcatdiv"> 
                    {!! Form::label('site', 'Sub Category', ['class' => 'control-label']) !!}
					 {!! Form::select('itemsubcategory', $subcategory, '', ['class' => 'form-control select2mes', 'id' => 'itemsubcategory']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <select name="uom" class="form-control routine">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="file" class="form-control" name="browse">  
                </div> 
            </div> 
			
		<div class="row description-row">
                <div class="col-xs-12 form-group description">
