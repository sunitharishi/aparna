...
.dlyrep-select.fire2mis.month-year
{
 margin-bottom:0px;
}
.dlyrep-select.fire2mis.month-year label
{
 width: 40px;
 float: left;
 color: #ff2518;
...
.dlyrep-select.month-year select
{
 width:200px;
 float:left;
}
...
.save-button input[type="submit"]
	...
	.form-group.route-post
	{
	 margin-bottom:0px;
	}
	
	.fire-issssue .col-sm-4
	{
	 margin-bottom:10px;
	}
	.fire-issssue .col-sm-8
	{
	 margin-bottom:10px;
	}
	.fire-issssue
...
<div class="misback-button"><a href="/misreportsoptions/<?php echo $year."/".$month ?>">Back</a></div>
    ...
    <h3 class="page-title report-wquipment"><b>MIS Reports   >>   WSP Equipment Status</b></h3>
	...
	{!! Form::open(['method' => 'POST', 'route' => ['misreports.storemiswsp'], 'class' => 'for-labelling' ,'onsubmit' =>"return subform()"]) !!}
	<div class="row">
                <div class="col-xs-12 form-group route-post">
				...
				<?php /*?> {!! Form::label('dailycat', 'Community', ['class' => 'control-label']) !!}
					...
					<div class="dlyrep-select fire2mis month-year">
          ...
          <div id="reportblock" style="display:none">  
            <div class="col-md-12 col-sm-12 col-xs-12 algebra">
              <div class="x_panel tile fixed_height_400 algebra1">
                <div class="x_title">
                   <!--<h3>Metro Water Supply details from  01.12.2017 to 31.12.2017</h3>-->
                </div>
                <div class="x_content for-freeee">
    
    
	<div class="docs-main wsp-equipment">
       ...
       <!--   <h3>  Fire Safety Equipment Status </h3>    -->
					   ...
					   <?php  $n=0; ?>  
           <div class="fireseafmis"><input type="checkbox" value="correct" class="confirmed" name="confirmdata"><span style="color:#1a816f;font-weight:bold;">Save as</span><span style="color:#c22804;font-weight:bold;"> Draft</span></div>
	 ...
	 var thisvalue = $( this ).text();
	  var selectedText = $(this).find("option:selected").text();
	   ...
	   $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('validation.getwspmsvalues') }}',
...
return false;    
 ...
 function addFormField(dis,text) {
	 ...
	 function addFormFieldnew(dis,text) {
		...
		$("#divTxt").append("<div id='row" + dis + "' class='row" + dis + " straigh-tcurve'><div class='col-sm-4 notificestobe-keep'><label>Description of Issue</label></div><div class='col-sm-8 notificestobe-keep'><input type='hidden' name='category[]' value='"+val+"'><input type='text' class='form-control' placeholder='' name='issue_des[]'/></div><div class='col-sm-4'><label>Root Cause</label></div><div class='col-sm-8'><input type='text' class='form-control' placeholder='' name='root_cause[]'/></div><div class='col-sm-4'><label>Action Required/Planned</label></div><div class='col-sm-8'><input type='text' class='form-control' placeholder='' name='act_req_plan[]'/></div><div class='col-sm-4'><label>Pending From Days</label></div><div class='col-sm-8'><input type='text' class='form-control' placeholder='' name='pendingfromdays[]'/></div><div class='col-sm-4'><label>Responsibility</label></div><div class='col-sm-8'><input type='text' class='form-control' placeholder=' ' name='reponsibility[]'/></div><div class='col-sm-4'><label>Notified to the Concern</label></div><div class='col-sm-8'><input type='text' class='form-control' placeholder='Notified to the Concern' name='notify_concern[]'/></div><div class='col-sm-4 col-xs-4'><label>Estimation Date</label></div><div class='col-sm-8 col-xs-8'><input type='text' class='form-control' placeholder=' ' name='estimation_time[]'/></div></div>");
