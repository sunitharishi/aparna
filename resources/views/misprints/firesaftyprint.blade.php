                    ...
                    <div class="manjeera">
					 <?php $keysarray =array("1"=>"Jockey Pump","2"=>"Main Pump","3"=>"DG Pump","4"=>"Booster Pumps","5"=>"Dewatering Pumps","6"=>"Yard Hydrant Points","7"=>"Cellar Hydrant Points","8"=>"Sub Cellar Hydrant Points","9"=>"Fire Hose Reel Drums","10"=>"Fire Alarm System","11"=>"Public Addressing System","12"=>"Fire Extinguishers","13"=>"Carbon Emission System","14"=>"Flow Meter Paneles - Fire Sprinkler","15"=>"CP Hoses","16"=>"Fire Alaram Repeater Panels","17"=>"Sprinkler Charged (floor wise)","18"=>"Fire Mock Drill & Emergency Evacuation","19"=>"False Fire Alarms","20"=>"Wet Raisers","21"=>"Sub Cellar-3 Hydrant Points","22"=>"PA System Repeater Panel","23"=>"Group Indication Panel"); ?>
                        ...
                        @foreach ($issuecount as $ikey => $issuecn)
						 <?php $xc = $xc + 1;; ?>
                        <?php //echo "<pre>"; print_r($misprevious[$ikey]); echo "</pre>";  ?>
                      
                        <div class="myElementClass previewprrrr" <?php if($xc == count($issuecount) && $issuecn == 0) {} else { ?>style="page-break-after: always;" <?php } ?>>
                           <table width="100%" border="1" cellspacing="0" cellpadding="2" class="wquipment-statue1" style="font-size:11px;text-align:center;">
                        <tbody>
                          <tr>
                      ...
                      <tr>
                       ...
                       <td><span><?php  if(isset($misres[$ikey]['firealarm_sysm'])) echo $misres[$ikey]['firealarm_sysm']; ?><?php if(isset($misprevious[$ikey][''])) { if((int)$misprevious[$ikey]['firealarm_sysm'] > 0 ) echo  "(".$misprevious[$ikey]['firealarm_sysm'].")"; } ?></span></td>
                        <td colspan="3"><span> </span></td>
                       ...
                       <?php if($issuecn > 5) { ?>
						    <?php if(isset($issuetemp[$ikey])) { ?>
                             <div class="myElementClass previewprrrr" <?php  if($xc == count($issuecount)) {} else { ?>style=" page-break-after: always;" <?php } ?>>
