...
-ms-transform: rotate(270deg) ;
	...
	font-size:11.5px;
         ...
         .notleapyear tr th, .notleapyear tr td
        {
          padding:3px 2px;
         }
	.leapyear tbody tr th
	{
	 padding:7px 2px;
	}
	.leapyear tbody tr td
	{
	 padding:7px 2px;
	}
	.manjeera table
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="width:100%;">
              <div class="x_panel tile fixed_height_400" style="border:none;">
                ...
                <div class="x_content">
                    ...
                    <div class="manjeera">
                      <table width="100%" border="1" cellspacing="0" <?php if(count($sitearr['dateres']) == 28) {  echo "class='leapyear'"; } if(count($sitearr['dateres']) > 28) {  echo "class='notleapyear'"; } ?>>
                        <tbody>
                          <tr>
                           <th colspan="<?php echo count($sitearr['community']) + 3; ?>" style="font-size:14px;padding:6px 0px;">Metro Water Supply details from  <?php echo $reportfrom_on." to ".$report_on; ?> </th>
                          </tr> 
                          <tr>
						...
						<?php } ?>
                          ...
                          <tr>
                             <td rowspan="<?php echo count($sitearr['dateres']) + 1; ?>" class="rotate" style="border:0px;"><div style="width:15px;">Date</div></td>
                          </tr>
