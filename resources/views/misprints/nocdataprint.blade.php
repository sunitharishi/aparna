        ...
        <div class="first-div">
            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    @if (count($sarovarres) > 0)
                        <table cellpadding="0" cellspacing="0" border="1" width="100%" class="table table-bordered">
                            <thead>
                                <tr>
                                	<th colspan="4" style="overflow:hidden;padding:6px;">SAROVAR FIRE NOC DETAILS</th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                            <?php $i = 1; if(isset($sarovarres)) { foreach($sarovarres as $nocdata) {?>
                            <tr>
                            ...
                            <?php $i = $i + 1; } }?>
                             <?php  if(isset($sarovarinfo) && $sarovarinfo !="") { ?>
							<tr>
								<td colspan="4">
									<?php echo $sarovarinfo; ?>
								</td>
							</tr>
							<?php } ?>
                            </tbody>
                    ...
                    <table width="100%" border="1"  class="inner-sarvoure" cellpadding="6">
                        <thead>
                            <tr>
                            	<th colspan="4">HILLPARK LAKE BREEZE FIRE NOC DETAILS</th>
                            </tr>
                            <tr>
                                <th style="line-height:30px;">S.No</th>
                                <th style="line-height:30px;">Block</th>
                        ...
                        <?php $i = $i + 1; } }?>
                         <?php  if(isset($lakebinfo) && $lakebinfo !="") { ?>
							<tr>
								<td colspan="4">
									<?php echo $lakebinfo; ?>
								</td>
                    ...
                    <br><br>
                      @if (count($towers) > 0)
                        <table cellpadding="0" cellspacing="0" border="1" width="100%" class="table table-bordered">
                            <thead>
                                <tr>
                                	<th colspan="4" style="padding:6px;">TOWERS FIRE NOC DETAILS</th>
                                </tr>
                                <tr>
                                    <th>S.No</th>
                                    <th>Block</th>
                            ...
                            <?php $i = $i + 1; } }?>
                            	 <?php  if(isset($towerinfo) && $towerinfo !="") { ?>
							<tr>
								<td colspan="4">
									<?php echo $towerinfo; ?>
								</td>
