            ...
            <table width="100%" border="1" cellspacing="0" class="primary-table1  <?php  if(isset($misres[$ikey]['additional_info'])){ $te = strip_tags($misres[$ikey]['additional_info']); if($te) { echo 'equadditionin'; } } ?>">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['misfull_nw'])) echo $misres[$ikey]['misfull_nw']; ?><?php if(isset($misprevious[$ikey]['misfull_nw'])) { if((int)$misprevious[$ikey]['misfull_nw'] > 0 ) echo  "(".$misprevious[$ikey]['misfull_nw'].")"; } ?></span></td>
                        <td colspan="3"><span></span></td>
                    ...
                    <tr>
                        ...
                        <td><?php if(isset($misres[$ikey]['sewerage_nw'])) echo $misres[$ikey]['sewerage_nw']; ?><?php if(isset($misprevious[$ikey]['sewerage_nw'])) { if((int)$misprevious[$ikey]['sewerage_nw'] > 0 ) echo  "(".$misprevious[$ikey]['sewerage_nw'].")"; } ?></td>
                        <td colspan="3"><span></span></td>
                    ...
                    <tr>
                        ...
                        <td><?php if(isset($misres[$ikey]['irrigatn_spr_as_nw'])) echo $misres[$ikey]['irrigatn_spr_as_nw']; ?><?php if(isset($misprevious[$ikey]['irrigatn_spr_as_nw'])) { if((int)$misprevious[$ikey]['irrigatn_spr_as_nw'] > 0 ) echo  "(".$misprevious[$ikey]['irrigatn_spr_as_nw'].")"; } ?></td>
                        <td colspan="3"><span></span></td>
                    ...
                    <tr>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['mis_outdoorpool_nw'])) echo $misres[$ikey]['mis_outdoorpool_nw']; ?><?php if(isset($misprevious[$ikey]['mist_fountain_nw'])) { if((int)$misprevious[$ikey]['mis_outdoorpool_nw'] > 0 ) echo  "(".$misprevious[$ikey]['mis_outdoorpool_nw'].")"; } ?></span> </td>
                        <td colspan="3"><span></span></td>
                    ...
                    <tr>
                        ...
                        <td><?php if(isset($misres[$ikey]['mis_babypool_nw'])) echo $misres[$ikey]['mis_babypool_nw']; ?><?php if(isset($misprevious[$ikey]['mis_babypool_nw'])) { if((int)$misprevious[$ikey]['mis_babypool_nw'] > 0 ) echo  "(".$misprevious[$ikey]['mis_babypool_nw'].")"; } ?></td>
                        <td colspan="3"><span></span></td>
                    ...
                    <tr>
                        ...
                        <td><?php if(isset($misres[$ikey]['gas_bank_chambr_nw'])) echo $misres[$ikey]['gas_bank_chambr_nw']; ?><?php if(isset($misprevious[$ikey]['gas_bank_chambr_nw'])) { if((int)$misprevious[$ikey]['gas_bank_chambr_nw'] > 0 ) echo  "(".$misprevious[$ikey]['gas_bank_chambr_nw'].")"; } ?></td>
                        <td colspan="3"><span></span></td>
                        <td><span><?php if(isset($misres[$ikey]['gas_bank_chambr_dtm'])) echo $misres[$ikey]['gas_bank_chambr_dtm']; ?></span> </td>
                        
                    </tr>
                	 <tr>
                           <td rowspan="2"><b>Air Handling Unit(AHU)</b></td>
                          <td class="text-center"><b>43</b></td>
                        <td class="sarlef"><b>Fresh Air</b></td>  
                        <td class="text-center"><span><?php if(isset($validation[$ikey]['misfreshair'])) echo $validation[$ikey]['misfreshair']; ?></span> </td>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['fresh_air_dtm'])) echo $misres[$ikey]['fresh_air_dtm']; ?></span> </td>
                           ...
                           <tr>
                          <td class="text-center"><b>44</b></td>
                       	  <td class="sarlef"><b>STP AHU</b></td>
                        <td class="text-center"><span><?php if(isset($validation[$ikey]['misstpahu'])) echo $validation[$ikey]['misstpahu']; ?></span> </td>
