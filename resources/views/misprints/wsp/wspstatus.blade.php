 ...
 <?php $keysarray =array("1"=>"Filter Feed Pump","2"=>"De-watering Pump","3"=>"Chlorine Dosing Pump","4"=>"Hydro Pneumatic Pump","5"=>"Pneumatic System Panel","6"=>"WSP MCC Panel","7"=>"Pressure Sand Filter","8"=>"Softener"); ?> 
  @if (count($issuecount) > 0) <?php $xc = 0; ?>
                      ...
                      <table width="100%" border="1" cellspacing="0" class="classic-folk <?php  if(isset($misres[$ikey]['additional_info'])){ $te = strip_tags($misres[$ikey]['additional_info']); if($te) { echo 'wspequadditionin'; } } ?>" style="font-size:12px;">
                        <tbody>
                          <tr>
                           <th colspan="6" style="font-size:15px;text-align:center;padding:5px;">  <span><?php echo get_sitename($ikey); ?> </span>WSP Equipment Status</th>
                          </tr>
                      <tr>
                      ...
                      <tr> 
                       ...
                       <tr> 
                        ...
                        <td><span><?php if(isset($misres[$ikey]['filter_feed_pmp'])) echo $misres[$ikey]['filter_feed_pmp']; ?></span> </td>
                      ...
                      <tr>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['de_Water_pump'])) echo $misres[$ikey]['de_Water_pump']; ?></span> </td>
                       ...
                       <tr>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['chlr_dos_pump'])) echo $misres[$ikey]['chlr_dos_pump']; ?></span> </td>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['hydro_pneuamt_pump'])) echo $misres[$ikey]['hydro_pneuamt_pump']; ?></span> </td>
                      ...
                      <tr>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['pneumatic_sys_pa'])) echo $misres[$ikey]['pneumatic_sys_pa']; ?></span> </td>
                      ...
                      <tr>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['wsp_mcc_panel'])) echo $misres[$ikey]['wsp_mcc_panel']; ?></span> </td>
                      ...
                      <tr>
                       ...
                       <td><span><?php if(isset($validation[$ikey]['wsppresssandfilter'])) echo $validation[$ikey]['wsppresssandfilter']; ?></span> </td>
                        <td><span><?php if(isset($misres[$ikey]['pressure_san_filt'])) echo $misres[$ikey]['pressure_san_filt']; ?></span> </td>
                      ...
                      <tr>
                        ...
                        <td><span><?php if(isset($misres[$ikey]['softner'])) echo $misres[$ikey]['softner']; ?></span> </td>
                      ...
                      <tr>
                        <td><b>10</b></td>
                        <td colspan="2" class="sarlef"><b>Raw Water PPM Level</b></td>
                       ...
                       <div class="codel-infoirmation"> <?php  if(isset($misres[$ikey]['additional_info'])){ $te = strip_tags($misres[$ikey]['additional_info']); if($te) { echo "<b>Note:</b>".$misres[$ikey]['additional_info']; } } ?></div>
                        ...
                        <tbody>
                          <tr>
                           <th colspan="<?php echo (int)$issuecn + 1;   ?>" style="font-size:15px;text-align:center;padding:5px;"> <span><?php echo get_sitename($ikey); ?> </span> WSP Not working Data</th>
                          </tr>
