...
<div class="manjeera">
<?php 
   if(isset($existsectwo['sites']) && count($existsectwo['sites'])>0) { ?>
    <div style="margin-bottom:10px; <?php if(isset($existsec['sites']) && count($existsec['sites'])>0) { ?>page-break-after: always;<?php } ?>>" 
	<?php if(isset($existsec['sites']) && count($existsec['sites'])>0) { ?>class="previewprrrr" <?php } ?>>
...
<?php if(isset($existsec['sites']) && count($existsec['sites'])>0) { ?>
    <div >
