                                           ...
                                           <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="colorboxes" style="background-color:#593d28; border-color:#593d28;">
                                                    <h3>Tasks</h3>
	                                                <div class="circle-img"><i class="fa fa-tasks" aria-hidden="true"></i><span>{{ $tcn }}</span></div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="colorboxes" style="background-color:#314d55; border-color:#314d55;">
	                                                ...
	                                                <div class="circle-img"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>{{ $brdcn }}</span></div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="colorboxes" style="background-color:#1c87bf; border-color:#1c87bf;">
	                                                ...
	                                                <div class="circle-img"><i class="fa fa-indent" aria-hidden="true"></i><span>{{ $inccn }}</span></div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="colorboxes" style="background-color:#8e4383; border-color:#8e4383;">
                                                    <h3>Job Cards</h3>
	                                                <div class="circle-img"><i class="fa fa-thumb-tack" aria-hidden="true"></i><span>{{ $jbbcn }}</span></div>
