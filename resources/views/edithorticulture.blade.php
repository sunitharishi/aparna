			  ...
			  <div class="row">
			  	   <div class="col-md-12 col-sm-12 col-xs-12 pms-blade">
				   		<div class="x_panel tile fixed_height_400">
                            ...
                            <input type="hidden" name="wateringid" value="<?php echo $water_count; ?>" id="wateringid" />
								...
								<div class="col-sm-12 col-xs-12 land-scaping"> 
									 <div class="col-sm-4 col-xs-3 fro-pro land-attendance">
										 ...
										 <div class="col-sm-4 col-xs-4 fro-pro sup">
												...
												{!! Form::number('land_atten_sup', $res['land_atten_sup'], ['class' => 'form-control ereq number', 'id'=>'land_atten_sup', 'placeholder' => '']) !!}
										 ...
										 <div class="col-sm-4 col-xs-4 helper">
											  ...
											  {!! Form::number('land_atten_helper', $res['land_atten_helper'], ['class' => 'form-control ereq number', 'id'=>'land_atten_helper', 'placeholder' => '']) !!}
									...
									<div class="col-sm-4 col-xs-3 fro-pro watering-time">
										 ...
										 <div class="col-sm-4 col-xs-4 watering">
											  ...
											  {!! Form::number('land_water_qty', $res['land_water_qty'], ['class' => 'form-control ereq number', 'placeholder' => 'KL']) !!}
										</div>
										<div class="col-sm-4 col-xs-4 time">
											  <label class="col-sm-12 col-xs-12">Duration</label>			
											  {!! Form::text('land_water_time', $res['land_water_time'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}
										</div>
									</div>
                             </div>
                         </div>
						 	  ...
						 	  <div class="col-sm-12 col-xs-12 land-scaping"> 
							  		<div class="col-sm-4 col-xs-3 fro-pro land-attendance">
										 ...
										 <div class="col-sm-4 col-xs-4 fro-pro sup">
												...
												{!! Form::number('solonide_valve_nw', $res['solonide_valve_nw'], ['class' => 'form-control ereq', 'id'=>'solonide_valve_nw', 'onchange'=>'checknwvalvevalidate(this,this.value,"solonide_valve_nw","solonide_reason_div")', 'placeholder' => 'Not Working']) !!}
                                                
                                                {!! Form::number('solonide_valve_rw', $res['solonide_valve_rw'], ['class' => 'form-control ereq', 'id'=>'solonide_valve_rw', 'placeholder' => 'Resolved']) !!}
                                                
												<div class="solonide_valve_nw_err"></div>
												
												<div style="display:none;" class="solonide_reason_div">{!! Form::text('solonide_valve_reason', $res['solonide_valve_reason'], ['class' => 'form-control ereq', 'id'=>'solonide_valve_reason', 'placeholder' => 'Reason']) !!}</div>
									...
									<div class="col-sm-4 col-xs-3 fro-pro land-attendance">
										 ...
										 <div class="col-sm-4 col-xs-4 fro-pro sup">
												...
												{!! Form::number('land_clean_sprinknw', $res['land_clean_sprinknw'], ['class' => 'form-control ereq', 'id'=>'land_clean_sprinknw', 'onchange'=>'checknwvalvevalidate(this,this.value,"land_clean_sprinknw","sprink_reason_div")', 'placeholder' => 'Not Working']) !!}
                                                
                                                {!! Form::number('land_clean_sprinkrw', $res['land_clean_sprinkrw'], ['class' => 'form-control ereq', 'id'=>'land_clean_sprinkrw', 'placeholder' => 'Resolved']) !!}
                                                
												<div class="land_clean_sprinknw_err"></div>
												<div style="display:none;" class="sprink_reason_div">{!! Form::text('land_clean_sprink_reason', $res['land_clean_sprink_reason'], ['class' => 'form-control ereq', 'id'=>'land_clean_sprink_reason', 'placeholder' => 'Reason']) !!}</div>
									...
									<div class="col-sm-4 col-xs-3 fro-pro land-attendance">
										 ...
										 <div class="col-sm-4 col-xs-4 fro-pro sup">
												...
												{!! Form::number('quick_couple_nw', $res['quick_couple_nw'], ['class' => 'form-control ereq', 'id'=>'quick_couple_nw', 'onchange'=>'checknwvalvevalidate(this,this.value,"quick_couple_nw","quick_reason_div")', 'placeholder' => 'Not Working']) !!}
                                                
                                                {!! Form::number('quick_couple_rw', $res['quick_couple_rw'], ['class' => 'form-control ereq', 'id'=>'quick_couple_rw', 'placeholder' => 'Resolved']) !!}
                                                
                                                
												<div class="quick_couple_nw_err"></div>
												<div style="display:none;" class="quick_reason_div">{!! Form::text('quick_couple_reason', $res['quick_couple_reason'], ['class' => 'form-control ereq', 'id'=>'quick_couple_reason', 'placeholder' => 'Reason']) !!}</div>
						 	  ...
						 	  <div class="col-sm-12 col-xs-12 land-scaping"> 
							  	   <table border="0" cellpadding="0" cellspacing="0" width="100%">
										  ...
										  <tr>
												...
												<td>
													<div style="float:left;">Start Time:</div> <div style="float:left;">{!! Form::text('drip_stime1', $res['drip_stime1'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Start Time:</div> <div style="float:left;">{!! Form::text('drip_stime2', $res['drip_stime2'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Start Time:</div> <div style="float:left;">{!! Form::text('drip_stime3', $res['drip_stime3'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
										  </tr>
										  <tr>
										   ...
										   <tr>
												<td>
													<div style="float:left;">Stop Time:</div> <div style="float:left;">{!! Form::text('drip_sotime1', $res['drip_sotime1'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Stop Time:</div> <div style="float:left;">{!! Form::text('drip_sotime2', $res['drip_sotime2'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Stop Time:</div> <div style="float:left;">{!! Form::text('drip_sotime3', $res['drip_sotime3'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
										  </tr>
										  <tr>
										   ...
										   <tr>
												...
												<td>
													<div style="float:left;">Start Time:</div> <div style="float:left;">{!! Form::text('sprink_stime1', $res['sprink_stime1'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Start Time:</div> <div style="float:left;">{!! Form::text('sprink_stime2', $res['sprink_stime2'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Start Time:</div> <div style="float:left;">{!! Form::text('sprink_stime3', $res['sprink_stime3'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
										  </tr>
										  <tr>
										  		<td colspan="3" height="10px"></td>
										  ...
										  <tr>
												<td>
													<div style="float:left;">Stop Time:</div> <div style="float:left;">{!! Form::text('sprink_sotime1', $res['sprink_sotime1'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Stop Time:</div> <div style="float:left;">{!! Form::text('sprink_sotime2', $res['sprink_sotime2'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
												<td>
													<div style="float:left;">Stop Time:</div> <div style="float:left;">{!! Form::text('sprink_sotime3', $res['sprink_sotime3'], ['class' => 'form-control ereq timepicker', 'placeholder' => '']) !!}</div>
												</td>
										  </tr>
								   </table>
							 </div>
									 ...
									 <div class="col-sm-8 col-xs-3 fro-pro land-attendance">
                                         ...
                                         <div class="col-sm-9 col-xs-9">
                                         	  ...
                                         	  <select name='wtype'  class='form-control ereq' style="width:150px;" onchange="mwtype(this.value)">
                                              		  <option value="auto" <?php if($res['wtype']=='Auto') echo "selected='selected'"; ?>>Auto</option>
                                                      <option value="manual" <?php if($res['wtype']=='manual') echo "selected='selected'"; ?>>Manual</option>
                                              </select>	
                                              </div>
                                              <div class="col-sm-12 col-xs-12" style="display: <?php if($res['wtype']=='manual') echo 'block'; else echo 'none'; ?>" id="manual_block">
											  	   <?php if(count($waterRes)>0) { ?>
                                                     ...
                                                     <div class="col-sm-12 col-xs-12 fro-pro land-attendance">													 	  
														<?php 														
															foreach($waterRes as $key=>$water)
															{
																$manpower = $water['manpower'];
																$mwhrs = $water['hrs'];
																$waterid = $water['id'];
																$locationsSel = $water['location'];
																$locations_Selected = explode(",",$locationsSel);
														?>
                                                         <div class="col-sm-4 col-xs-4">
														 	  <input type="hidden" name="waterid[]" value="<?php echo $waterid; ?>" />
                                                              <select name='mloc[<?php echo $waterid; ?>][]'  multiple="multiple" class='form-control'>
															  		  <?php
																	  	foreach($locations as $key=>$val)
																		{
																			echo $key."<br/>";
                                                         ...
                                                         <div class="col-sm-4 col-xs-4">
                                                             {!! Form::number('mmanpower[]', $manpower, ['class' => 'form-control', 'placeholder' => '']) !!}										 
                                                         </div>
                                                         <div class="col-sm-3 col-xs-3">
                                                              {!! Form::number('mwhrs[]', $mwhrs, ['class' => 'form-control', 'placeholder' => '']) !!}										 
                                                         </div>
