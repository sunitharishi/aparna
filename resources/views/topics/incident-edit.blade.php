...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['incident.save'],'id'=>'frmBreakdown']) !!}
        ...
        <div class="panel-body incident-body">
            <div class="row class-ctration">
                ...
                <div class="col-sm-2 form-group incidernt-categoryu">
                    ...
                    @if(isset($incident))
                    {!! Form::select('category_id', $categories, old('category_id')?old('category_id'):(isset($comasset)?$comasset->category_id:$incident->category_id), ['class' => 'form-control select2mes erequired','onchange'=>'getTopicsCommunityAssets()','disabled'=>'disabled']) !!}
                    @else 
                ...
                <div class="col-sm-2 form-group breakdown-categoryund" id="subcatdiv">
                    ...
                    @if(isset($incident))
                    {!! Form::select('sub_category_id', $subcategories, old('sub_category_id')?old('sub_category_id'):(isset($incident)?$incident->sub_category_id:''), ['class' => 'form-control select2mes erequired','disabled'=>'disabled']) !!}
                    @else 
                    {!! Form::select('sub_category_id', $subcategories, old('sub_category_id')?old('sub_category_id'):(isset($incident)?$incident->sub_category_id:''), ['class' => 'form-control select2mes erequired']) !!}
                    @endif
                    <p class="help-block"></p>
            ...
            <div class="row">
                  ...
                  <div class="col-sm-2 form-group breakdown-title">
                    ...
                    {!! Form::text('title', old('title')?old('title'):(isset($incident)?$incident->title:''), ['class' => 'form-control erequired', 'placeholder' => '']) !!}
                </div>
