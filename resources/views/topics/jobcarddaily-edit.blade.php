...
<style type="text/css">
    ...
    <div class="panel panel-default smoonity-asstess">
        ...
        <div class="panel-heading">
           <?php echo "(".get_sitename($site_id).")";?>   Job Card {{ (isset($jobcard)?'Edit':'New') }}
            <p class="ptag">
             ...
             <!--   @if($userid==1)
               ...
               <!-- @endif-->
                ...
                <div class="col-sm-2 form-group incident-idb" id="sparesblock">
                    ...
                    {!! Form::select('spares', $spares_List, old('spares')?old('spares'):(isset($jobcard)?$jobcard->spares:''), ['class' => 'form-control select2mes erequired','id'=>'spare_id']) !!}
                    <p class="help-block"></p>
