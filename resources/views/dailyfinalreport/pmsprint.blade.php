            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="tile fixed_height_400">
                ...
                <div class="x_title main-tera-hero">
                   ...
                   <div class="col-sm-6 col-xs-6 date pms"><?php /*?><input type="text" style="border:1px solid #000;" value=""><?php */?>PMS | DATE: <?php echo $datefilter;?> | TIME: <?php date_default_timezone_set('Asia/Kolkata'); echo date("h:i:sa"); $pemsresv = getdefaultpmstot($sitefilter); ?></div>
                	...
                	<table  border="1" width="80%" style="text-align:left;font-size:12px;border:1px solid #000;" class="print">
                    	...
                    	<tbody style="border:1px solid #000;">
                        	...
                        	<tr style="text-align:left;background-color:#ffc1070f;">
                                ...
                                <td><b>Solenoid Valves</b></td>
                                <td><b>Quick Coupling valves</b></td>
                                <td><b>Power point</b></td>
                               
                                
                                <?php /*?><td rowspan="3" class="text-left" style="border-bottom:1px solid #fff;"><?php if(isset($res['land_spray_location'])) { if($res['land_spray_location']) echo '<b>Lawn Mowing:</b> <span>'.$res['land_spray_location']."</span><br>"; } ?><?php if(isset($res['land_Weeding_location'])) { if($res['land_Weeding_location']) echo '<b>Lawn Edge Cutting:</b> <span> '.$res['land_Weeding_location']."</span><br>"; }?><?php if(isset($res['land_mowing_location'])) { if($res['land_mowing_location']) echo '<b>Pesticide Application:</b> <span>'.$res['land_mowing_location']."<br>"; }?></span>
                                
                                   <b>Fertilizer Application: </b><span><?php if(isset($res['land_application']))echo $res['land_application']; ?></span> <br />
                                     <b>Garden Waste Disposal: </b><span><?php if(isset($res['land_garden_waste']))echo $res['land_garden_waste']; ?></span> <br />
                                     <b>Extra Activities: </b> <span><?php if(isset($res['land_extra_activity']))echo $res['land_extra_activity']; ?></span> <br />
                                     
                                     <?php if(isset($res['land_mulching'])) { if($res['land_mulching']) echo '<b>Manual Watering:</b> <span>'.$res['land_mulching']."</span><br>"; } ?>

								<?php if(isset($res['land_trimming'])) { if($res['land_trimming']) echo '<b>Weeding:</b> <span>'.$res['land_trimming']."</span><br>"; } ?>

								<?php if(isset($res['land_cutting'])) { if($res['land_cutting']) echo '<b>Hoeing:</b> <span>'.$res['land_cutting']."</span><br>"; }?>

								<?php if(isset($res['land_pruning'])){ if($res['land_pruning']) echo '<b>Trimming:</b> <span>'.$res['land_pruning']."</span><br>"; }?>

								<?php if(isset($res['land_shaping'])){ if($res['land_shaping']) echo '<b>Pruning:</b> <span>'.$res['land_shaping']."</span><br>"; }?>

								<?php if(isset($res['land_hoeing'])) { if($res['land_hoeing']) echo '<b>Cleaning:</b> <span>'.$res['land_hoeing']."</span><br>"; }?>
                         ...
                         <td>Sup: <span><?php if(isset($res['land_atten_sup']))echo $res['land_atten_sup']; ?> /<?php echo $pemsresv['land_sup'];?> </span>&nbsp;&nbsp;&nbsp;&nbsp;
                             Helper: <span><?php if(isset($res['land_atten_helper']))echo $res['land_atten_helper']; ?> / <?php echo $pemsresv['land_helper'];?> </span>
                                ...
                                <td>Qty (Kl): <span><?php if(isset($res['land_water_qty']))echo $res['land_water_qty']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table border="1" width="80%" style="font-size:12px;border:1px solid #000;">
                    	...
                    	<tbody style="border:1px solid #000;">
                        	...
                        	<tr>
                            	...
                            	<td style="background-color:#ffc1070f;"><b>Attendance</b></td>

                                <td style="background-color:#ffc1070f;"><b>Ride on</b></td>
                                <td style="background-color:#ffc1070f;"><b>Scrubbing</b></td>
                                <td style="background-color:#ffc1070f;"><b>Fogging</b></td>
                                <td style="background-color:#ffc1070f;"><b>Garbage</b></td>
                                <td style="background-color:#ffc1070f;"><b>Debris</b></td>
                                
                           	</tr>

                            <tr> 

                            	<td>Sup: <span><?php if(isset($res['housekp_atten_sup']))echo $res['housekp_atten_sup']; ?> / <?php echo $pemsresv['house_sup'];?></span></td>

                                <td>Hrs Run: <span><?php if(isset($res['housekp_rideon_hrs']))echo $res['housekp_rideon_hrs']; ?></span></td>
                                <td>Hrs Run: <span><?php if(isset($res['scrub_hrs_run']))echo $res['scrub_hrs_run']; ?></span></td>
                                <td>Hrs Run: <span><?php if(isset($res['fogg_hrs_run']))echo $res['fogg_hrs_run']; ?></span></td>
                                <td rowspan="2">Out Time: <span><?php if(isset($res['housekp_debr_garbage']))echo $res['housekp_debr_garbage']; ?></span></td>

                                <td>No.of Trips: <span><?php if(isset($res['housekp_debr_tipsnum']))echo $res['housekp_debr_tipsnum']; ?></span></td>
                            ...
                            <tr>
                            	...
                            	<td>Helper: <span><?php if(isset($res['housekp_atten_helper']))echo $res['housekp_atten_helper']; ?> /<?php echo $pemsresv['house_help'];?> </span></td>

                                <td>Location: <span><?php if(isset($res['housekp_location']))echo $res['housekp_location']; ?></span></td>
                                <td>Location: <span><?php if(isset($res['scrub_location']))echo $res['scrub_location']; ?></span></td>
                                <td>Location: <span><?php if(isset($res['fogg_location']))echo $res['fogg_location']; ?></span></td>
                               

                                <td>Vol (CFT): <span><?php if(isset($res['housekp_debr_vol']))echo $res['housekp_debr_vol']; ?></span></td>

                            </tr>
                            <tr>
                              <td colspan="4" class="text-left" style="border-bottom:1px solid #fff;"><?php if(isset($res['housekp_thefts'])) {if($res['housekp_thefts']) echo '<b>Thefts: </b><span>'.$res['housekp_thefts']."</span><br>"; } ?>
								...
								<?php if(isset($res['housekp_area_inspect'])) {if($res['housekp_area_inspect']) echo '<b>Areas Inspected: </b><span>'.$res['housekp_area_inspect']."</span><br>"; }?>

								<?php if(isset($res['housekp_pest'])) {if($res['housekp_pest']) echo '<b>Pest: </b><span>'.$res['housekp_pest']."</span><br>"; }?>

								</td>
                                <td colspan="2" style="border-bottom:1px solid #fff;"><b>Remarks: </b><br /><span><?php if(isset($res['housekp_remarks']))echo $res['housekp_remarks']; ?></span>
                                </td>
                            </tr>
                    ...
                    <table  border="1" width="80%" style="font-size:12px;border:1px solid #000;">
                    	...
                    	<tbody style="border:1px solid #000;">
                        	...
                        	<tr style="background-color:#b8cde6;">
                            	...
                            	<td rowspan="5" class="rotate-text" style="border-bottom:1px solid #fff;"><div style="width: 55px;">Club House</div></td>
                            ...
                            <tr> 
                            	...
                            	<td>F.O: <span><?php if(isset($res['clbhous_att_frntofc']))echo $res['clbhous_att_frntofc']; ?> /<?php echo $pemsresv['clu_hs_fo'];?> </span>&nbsp;&nbsp;&nbsp;
                                    H.K: <span><?php if(isset($res['clbhous_att_housekp']))echo $res['clbhous_att_housekp']; ?> /<?php echo $pemsresv['clu_hs_hk'];?> </span>
                                  &nbsp;&nbsp;&nbsp;
                                   Supervisor: <span><?php if(isset($res['supervisor']))echo $res['supervisor']; ?></span><br />
                                ...
                                <td>Day: <span><?php if(isset($res['clbhous_revenue_day']))echo $res['clbhous_revenue_day']; ?></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    Cum.: <span><?php echo getpmsmtd($datefilter,$sitefilter,'clbhous_revenue_day'); ?></span> <br />
                            ...
                            <tr style="border-bottom:1px solid #fff;">
                               <td colspan="4" class="text-left"><b>Remarks:</b> <span><?php if(isset($res['clbhous_users_remarks']))echo $res['clbhous_users_remarks']; ?></span></td>
                            </tr>
