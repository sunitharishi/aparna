...
@section('content')
    ...
    <div class="row">
    	 @include('partials.lefttemp')
        <div class="col-sm-9 rightpanel-view" id="sitedetail">    
            <div class="panel page-dashboard">  
                ...
                <div class="dashboard-tab-section">
                	<ul class='tabs tabs-daily'>
                        <li><a href='#tab1' class="dashboard">Dashboard</a></li>
                        <li><a href='#tab2' class="firesafety">Fire Safety</a></li>
                        <li><a href='#tab3' class="fms">FMS</a></li>
                        <li><a href='#tab4' class="pms">PMS</a></li>
                        <li><a href='#tab5' class="security">Security</a></li>
                    </ul>
                    <div class="tabcontent" id="">
                                        ...
                                        <div class="col-sm-12 top-colorboxes">
                                           <div class="col-sm-2">
                                                <div class="colorboxes" style="background-color:#da7226; border-color:#da7226;">
                                                    <h3>Vendors</h3>
	                                                <div class="circle-img"><i class="fa fa-life-ring" aria-hidden="true"></i><span>3</span></div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="colorboxes" style="background-color:#593d28; border-color:#593d28;">
                                                    <h3>Tasks</h3>
	                                                <div class="circle-img"><i class="fa fa-tasks" aria-hidden="true"></i><span>{{ count($assets) }}</span></div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="colorboxes" style="background-color:#16a6b7; border-color:#16a6b7;">
                                                    ...
                                                    <a href="{{ route('indents.index') }}" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>	
                                            </div>
                                       ...
                                       <br />
                                        <div class="col-sm-12 table-section">
										  ...
										  <div class="inner-title">
                                                <h4><b>AMC/Waranty</b></h4>
                                            </div>
                                            <div class="dashboard-taskstable">
                                            <table class="table table-hover taasstable tasls-tablechas">
                                                ...
                                                <tbody>
                                                 @if (count($amcs) > 0)
                        							@foreach ($amcs as $client) 
                                                    <tr>
                                                    	<td>
															<?php 
                                                                if($client['sitename']!="") $siteName = $client['sitename']; else $siteName=""; 
                                                                echo $siteName; 
                                                            ?>
                                                        </td>
                                                        <td>
															<?php 
                                                                if($client['assetname']!="") $assetName = $client['assetname']; else $assetName=""; 
                                                                echo $assetName; 
                                                            ?>
                                                        </td>
                                                         <td>
															<?php 
                                                                if($client['vendorname']!="") $vendorName = $client['vendorname']; else $vendorName=""; 
                                                                echo $vendorName; 
                                                            ?>
                                                        </td>
                                                        <td>
                                                        	<?php
																...
																//echo $amc_intervals[$client->amc_interval] ;
															?>
                                                        </td>
                                                        <td>
                                                        	<?php echo $client->amc_type; ?>
                                                        </td>
                                                        <td>
                                                        	<?php echo date("d-m-Y",strtotime($client['amc_startdate'])); ?>
                                                        </td>
                                                        <td>
                                                        	<?php echo date("d-m-Y",strtotime($client['amc_enddate'])); ?>
                                                        </td>
                                                        <td>
                                                        	<?php echo date("d-m-Y",strtotime($client['alert_date'])); ?>
                                                        </td>
                                                    </tr>
                                                    <?php /*?><?php 
														if($client['assetname']!="") $assetName =$client['assetname']; else $assetName="";
                                                    ...
                                                    <tr>
                                                        <td><?php echo $siteName; ?></td>
                                                         <td><a href="/calendar"><?php echo $assetName; ?></a></td>
                                                        <td>&nbsp;</td>
														<?php
														$amc_intervals = array(15=>'15 days',45=>'45 days',30=>'monthly',60=>'2 months',90=>'3 months',120=>'4 months',150=>'5 months',180=>'6 months',240=>'8 months',360=>'yearly',''); ?>
														 <td ><?php echo $amc_intervals[$client['amc_interval']] ?></td>
                                                       <td style="color:red;"> <?php echo date("d-m-Y",strtotime($client['amc_startdate'])); ?></td>
													    <td style="color:red;"><?php  echo date("d-m-Y",strtotime($client['amc_enddate']));  ?></td>
                                                    </tr><?php */?>
                                                       @endforeach
                                                   @endif
                                           ...
                                           <div class="inner-title">
                                            ...
                                            <table class="table table-hover taasstable tasls-tablechas">
                                                ...
                                                <tbody>
                                                 <?php if(isset($assets)) {  //echo "test123".count($assets); exit;?>
                                                 @if (count($assets) > 0)
                        							@foreach ($assets as $asset)
                                                    <?php if($asset->tcode!=""){ ?>
                                                    <tr>
                                                      <td>{{ $asset->tcode }}</td>
                                                       <td>{{ (isset($asset->catgname)?$asset->catgname:'') }}</td>
                                                      <td><a href="{{ route('tasks.show',[$asset->id]) }}">{{ $asset->title }}</a></td>
                                            ...
                                            <div class="dashboard-forumstable">
                                            <table class="table table-hover foeeetable forums-tablechca">
                                                <thead class="thead-dark head-color">
                                                    <tr>
                                                        <th>Title</th>
                                                        <th>Category</th>
                                           ...
                                           <div class="dashboard-jobcardtable">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td><a href="{{ route('jobcard.view',[<?php echo $row['id']; ?>]) }}"><?php echo $row['refid']; ?></a></td>
                                                      <td><?php echo $row['sitename']; ?></td>
                                                      <td><?php echo $jbtypes[$row['jctype']]; ?></td>
                                            ...
                                            <div class="dashboard-incidentcardtable">
                                            <table class="table table-hover">
                                                <thead class="thead-dark head-color">
                                                    <tr>
                                                        <th>Date</th>
                                            ...
                                            @if($breakdowns)
                                            <div class="inner-title">
                                                <h4><b>Breakdown Report</b></h4>
                                            </div>
                                            
                                            <div class="dashboard-breakdownreport-table">
                                            <table class="table table-hover">
                                                <thead class="thead-dark head-color">
                                                    <tr>
                                                        <th>Date</th>
                                            ...
                                            <div class="dashboard-historycard-table">
                                            <table class="table table-hover">
                                                <thead class="thead-dark head-color">
                                                    <tr>
                                                        <th>Date</th>
                        ...
                        <div id='tab2'>
                        	<div class="dashboard-tab-section sub-tabs">
                                <ul class='tabs tabs-routine' style="position:relative; float:left; right:0px; margin-bottom:20px;">
                                    <li><a href='#tab6' class="jockeypump-main">Jockey Pump</a></li>
                                    <li><a href='#tab7' class="mainpump-main">Main Pump</a></li>
                                    <li><a href='#tab8' class="dgpump-main">DG Pump</a></li>
									<li><a href='#tab9' class="fireextsenn-main">Fire Extinguishers</a></li>
                                ...
                                <div class="tabcontent">
								 <?php 
													...
													$jknw = 0;
													$jkauto = 0;
												 foreach($sitenameson as $kk =>  $siten) {
                                    ...
                                    <div id='tab6'>
                                    	...
                                    	<div class="col-sm-6">
												...
												<?php /*?>TOT <span>{{ $jktot }}</span>
												 OFF<span>{{ $jkoff }}</span>
												 NW<span>{{ $jknw }}</span>
												 AUTO<span>{{ $jkauto }}</span><?php */?>
                        ...
                        <div id='tab3'>
						 ...
						 <h2 class="bluered">Power Consumption Data as on <span><?php 
                                ...
                                <div class="power-consumption-table">
							     <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped add-edit-rreg no-footer community-ctpt">
									...
									$date = date('Y-m-d');
									echo date('d-m-Y', strtotime($date .' -1 day')); ?></span></h2>
                                 <div class="wspdws-consumptiontable">
							     <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped add-edit-rreg no-footer">
                                           		<thead class="head-color">
                                                	<tr>
                                                    	<th>Community</th>
                                 ...
                                 <div class="stpfws-consumptiontable">
							     <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped add-edit-rreg no-footer">
                                           		<thead class="head-color">
                                                	<tr>
                                                    	<th>Community</th>
                                                        <th>Avg Inlet Water</th>
                                                        <th>Avg Treated Water </th>
                                                        <th>Avg Water Bypassed</th>
                                                    </tr>
                                                </thead>   
                                                <tbody>
												 @foreach($sitenameson as $kk =>  $siten)
                        ...
                        <div id='tab4'> 
                           ...
                           <div class="apan-apms-table">
							     <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped add-edit-rreg no-footer">
                                           		<thead class="head-color">
                                                	<tr>
                                                    	<th>Community</th>
                                                        <th>Previous</th>
                                                        <th>HelpDesk(Opened)</th>
                                                        <th>Login(Opened)</th>
                                                        <th>Total</th>
                                                        <th>Resolved</th>
                                                        <th>Pending</th>
                                ...
                                <div class="apna-complex-projecttable">
							     <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped add-edit-rreg no-footer">
                                           		<thead class="head-color">
                                                	<tr>
                                                    	<th>Community</th>
                        ...
                        <div id='tab5'>
                             ...
                             <div class="dashboard-securitydata-table">
							     <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped add-edit-rreg no-footer">
                                           		<thead class="head-color">
                                                	<tr>
                                                    	<th>Community</th>
...
$(function(){
    $("#chart").dxChart({
        ...
        title: "Department wise Employee Distribution [<b><span style='color:#F90;'>Total:</span> 1217</b>]",
        legend: {
...
<script>
function getsitedbdetails(id){  
   $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('validation.getsitedashboard') }}',
				data: { site: id},
				success: function( response ) {
				     
				$("#sitedetail").html(response);
