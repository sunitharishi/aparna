...
@section('content')
   <!-- <h3 class="page-title">Assets</h3>-->
    ...
    {!! Form::model($asset, ['method' => 'PUT', 'route' => ['emps.update', $asset->id]]) !!}
    ...
    <div class="panel panel-default panelmar respositroy-view employee">
        ...
        <div class="panel-body emp-sites-create creativeitye">
	    ...
	    <div class="row ftather-apnar-name">
                <div class="col-xs-12 form-group">
			...
			<div class="row aparna-informatijon">
                <div class="col-xs-12 form-group">
			...
			<div class="row checkbox-fields">
                <div class="col-xs-12 form-group sedines-list">
                    <label>Sites</label>
                   <ul>
                     @if (count($sites_names) > 0)  
                      <?php  
					     
						  $community_arr = explode(",",$asset->community);
						?> 
