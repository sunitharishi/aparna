...
@section('content')
   <!-- <h3 class="page-title">Employees</h3>-->
    {!! Form::open(['method' => 'POST', 'route' => ['emps.store']]) !!}

    <div class="panel panel-default panelmar respositroy-view employee">
        ...
        <div class="panel-body emp-sites-create employee-createrere">
        ...
        <div class="class-ctration">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
					...
					{{ Form::select('maritalstatus', ['Married', 'Unmarried'], old('maritalstatus'),  ['class' => 'form-control', 'placeholder' => '']) }}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
					...
					{{ Form::select('gender', ['Male', 'Female'], old('gender'),  ['class' => 'form-control', 'placeholder' => '']) }}
                    <p class="help-block"></p>
           ...
           <div class="class-ctration">
			<div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('temp_address', old('temp_address'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
			...
			<div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('permanent_address', old('permanent_address'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
			...
			<div class="row additional-information1">
                <div class="col-xs-12 form-group">
                    {!! Form::label('other', 'Additional Information', ['class' => 'control-label']) !!}
                    {!! Form::textarea('other', old('other'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('other'))
                        <p class="help-block">
                            {{ $errors->first('other') }}
            ...
            <div class="row checkbox-fields">
                <div class="col-xs-12 form-group">
                     ...
                     @if (count($sites_names) > 0)  
					  ...
					  <div class="checkbox-cnt"><span class="boxcheck">{{ Form::checkbox('community[]', $site->id,'',array('class'=>'use_select')) }}</span><span>{{ $site->name }}</span></div>
                           @endforeach 
    ...
    {!! Form::submit('Submit', ['class' => 'btn btn-danger btn-save btn-margin']) !!}
    {!! Form::close() !!}
