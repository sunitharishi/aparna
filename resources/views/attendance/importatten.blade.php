...
-ms-transform: rotate(270deg) ;
   ...
   .dailyreports .dlyrep-select select
   {
   	width:100% !important;
   }
   .attendeancesds 
...
<?php if(isset($empcodeerr)) { if($empcodeerr) echo "<b><label style='color:#FF0000;'>".$empcodeerr."</label> are not found in employee data Add those information in this <a href='/emps'>[Link]</a>"."</span></b>"; }?>
   <div class="misback-button"><a href="/attendance">Back</a></div> 
	<div class="dailyreports attendance-reports">
    <h3 class="page-title req" style="text-align:center;">Upload Attendance Reports</h3>

	{!! Form::open(['files' => 'true','route' => 'attendance.saveattendance','role' => 'form', 'class'=>'form-inline upload-attendance-form', 'onsubmit' =>"return subform()"]) !!}
	
	<div class="row">
                <div class="form-group attendeancesds" style="padding-left:0px;">
                ...
                <div class="form-group tran col-sm-12" style="padding-right:0px;">
                ...
                <input type="file" name="file" id="file" class="btn btn-info" title="Select File">
                         ...
                         <div class="desibtn">
						  ...
						  <div class="help-block"><strong>Note!</strong> <b>Only xls or xlsx file is allowed!!</b> <a href="{!! URL::to('/sampleattendance.xls') !!}">Click here for Sample File.</a></div>
