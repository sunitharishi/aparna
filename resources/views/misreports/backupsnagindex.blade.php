...
<style type="text/css">
  ...
  .empids .commoncom{clear: both;padding: 4px;margin: 4px;}
	...
	.individual-reportsites select, .individual-reportfrom input, .individual-reportto input {
		float: left;
		margin-right: 15px !important;
	}
	.individual-reportsites label, .individual-reportfrom label, .individual-reportto label
	{
    ...
    <div class="panel panel-default panelmar tsas-crseations ssnag-reportss">
        ...
        <div class="panel-heading">
         ...
         <div class="panel-body snag-body-section">
            ...
            <label class="label-individual-site">Sites<span>:</span></label><br />
            ...
            ?>
              ...
              <div class="individual-reportsites">
           	  ...
           	  <label class="label-individual-site">Categories<span>:</span></label><br />
			 ...
			 <div class="individual-reportsites">
           	  ...
           	  <label class="label-individual-site">Locations<span>:</span></label><br />


               {!! Form::select('locations', $locations, old('location'), ['multiple'=>'multiple', 'size'=>4, 'class' => 'form-control pms-auditreport', 'id' => 'location']) !!} 
              ...
              <div class="individual-reportfrom">
                ...
                <label class="label-individual-from">From<span>:</span></label><br />
             ...
             <div class="individual-reportto">
               ...
               <label class="label-individual-to">To<span>:</span></label><br />
            ...
            <div class="individual-buttons">
                <div class="individual-reportto" style="margin-right:10px;">
                  <label class="label-individual-to">&nbsp;<span></span></label><br />
                 ...
                 <table id="dTableColSearch" class="table datatable table-bordered table-striped emploiyee-table {{ count($auditresult) > 0 ? 'dTableColSearch' : '' }} dt-select">  
                    ...
                    <thead class="head-color">
                      ...
                      <tr data-entry-id="{{ $tt->id }}" id="record_{{ $tt->id }}">
                        ...
                        <td ><?php echo $sites[$kk]; ?></td>



                        <td >{{ $categories[$tt->cid] }}</td>
                        ...
                        <td>
                            <a target="_blank" href="/getsnagreportedit?sid=<?php echo $tt->id; ?>"
							 class="btn btn-xs btn-inverse">Edit</a> 
							 <?php /*?><a href="javascript:void(0);" onclick="snagEdit(<?php echo $tt->id; ?>);">Edit</a><?php */?>
  ...
  function getsnagreports(){
   ...
   var status = $("#status").val();
      ...
      $.ajax({
        ...
        data: { fromdate: fromdate, todate: todate, site: site, category: category, location: location, status: status},
