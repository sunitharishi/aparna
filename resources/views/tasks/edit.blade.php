        ...
        <div class="panel-body">
            ...
            <div class="row class-ctration">
                ...
                <div class="col-sm-2 form-group edit-employee-communities">
                    ...
                    {!! Form::select('site', $sites, old('site'), ['class' => 'form-control select2mes','onchange'=>'getCommunityUsers(this)']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('site'))
                        <p class="help-block">
                            {{ $errors->first('site') }}
            ...
            <div class="row">
			 ...
			 <div class="row">
              <div class="col-sm-2 form-group edit-emplaoiyee">
                    ...
                    <?php $dateval = $task->task_create_date; ?>
                     <span class="permission-space"><input type="text" name="task_create_date" id="example1" value="<?php echo date('d-m-Y', strtotime($dateval)); ?>" class="hasDatePicker form-control"></span>
                </div>
               <!-- {!! Form::label('', 'Task Assigners', ['class' => 'control-label']) !!}-->
                <div>
                  	 &nbsp;
            ...
            <div class="row class-ctration">
                 <div class="col-sm-3 form-group edit-ontrol-titla">
