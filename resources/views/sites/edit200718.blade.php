...
<div class="row latiti-longitude communitybackground">
   <label class="col-sm-12 control-label project-renewal">Project Maintenance Renewal </label>
   <div class="col-sm-2"> 
    ...
    @endif<?php */?>
     ...
     <div class="col-sm-1 floors-text" id="numpostpaiddiv" style="display:<?php if($sites['postpaid'] == 'Yes') echo 'block;'; else echo 'none;';?>">
        <label>&nbsp;</label>
...
<!----------------overview------------------->                     
 <div class="row communitybackground1 cerificed-rating"> 
     <label class="col-sm-12 overview">Over View</label>  
        ...
        <div class="col-sm-2" id="rating_block" style="display:<?php if($sites['igbc_certified'] == 'Yes') echo 'block;'; else echo 'none;';?>">
...
<!----------------flats-villas-------------------> 				        
    ...
    <div class="row communitybackground blocks-floores">
      ...
      <div class="col-xs-2 form-group flats-villas" id="villasblock" style="display:<?php if($sites['flat_type'] == 'villas') echo 'block;'; else echo 'none;';?>">
        ...
        <div class="col-xs-2 form-group flats-villas" id="flatsblock" style="display:<?php if($sites['flat_type'] == 'flats') echo 'block;'; else echo 'none;';?>">
    ...
    <div  id="flatgroupblock" style="display:<?php if($sites['flat_type'] == 'flats') echo 'block;'; else echo 'none;';?>">
     ...
     <div class="col-sm-1 floors-text" id="numfloordiv" style="display:<?php if($sites['num_of_floors'] == 'Yes') echo 'block;'; else echo 'none;';?>">
        <label>&nbsp;</label>
    ...
    <div class="col-sm-2">
      ...
      <div class="col-sm-1 floors-text" id="numofbasementdiv" style="display:<?php if($sites['basement_one'] == 'Yes') echo 'block;'; else echo 'none;';?>">
        <label>&nbsp;</label>
...
<!----------------rainwater-harvesting------------------->
<!----------------bms------------------->               
<div class="row communitybackground1 group-elevators">  
  <div class="col-sm-3 form-group bms-group">
    <label class="control-label bms">BMS</label>
    <label class="col-sm-12 prepaid-systeme">Prepaid  Systems</label>
    <ul>
    ...
    <div class="col-sm-3 form-group bms-group">
        <label class="col-sm-12 emptyu">&nbsp;</label>
        <label class="col-sm-12 postapsis-system"> PostPaid Systems</label>
        <ul>
  ...
  <div class="col-xs-2 form-group solar-power">
   ...
   <?php /*?> {!! Form::text('solar_power', old('solar_power'), ['class' => 'form-control', 'placeholder' => '']) !!}
    ...
    @endif<?php */?>
     ...
     <div class="col-xs-2 form-group solar-powert-text" style="display:<?php if($sites['solar_power'] == 'Yes') echo 'block;'; else echo 'none;';?>;" id="solartextblock">
       <label>&nbsp;</label>
...
<div class="row communitybackground1 srp-wep">
    ...
    <div class="col-sm-2 water-muncicipat" id="contractkldiv" style="display:<?php if($sites['municipal_water'] == 'Yes') echo 'block;'; else echo 'none;';?>;">
  ...
  <div class="col-xs-2 form-group wsp">
   ...
   <div class="col-sm-12 water-muncicipat">
...
<!----------------water-distributionsystem-------------------> 					
                  ...
                  <div class="row communitybackground all-fiee-measure">
                    <label class="col-sm-12 fire-safety">Fire & Safety</label>
					    <div class="col-sm-2 form-group">
                      <label class="control-label">Smoke</label>
                       {!! Form::text('smoke', old('smoke'), ['class' => 'form-control', 'placeholder' => '']) !!}
                  </div>
                   <div class="col-sm-4 form-group no-file-chosen">
              ...
              <div class="row communitybackground1 secuirty-puropose">
                   <label class="col-sm-12 control-label security">Security</label>
                    ...
                    <div class="col-sm-2 form-group cctv">
                       <label class="col-sm-12 cctn">CCTV</label>
                       <label class="col-sm-12 number">Number</label>
                       {!! Form::text('cctv_number', old('cctv_number'), ['class' => 'form-control', 'placeholder' => '']) !!}
                   </div>
                   <div class="col-sm-2 form-group">
                    <label class="control-label empty">&nbsp;</label>
                       <label class="col-sm-12 make">Make</label>
                       {!! Form::text('cctv_make', old('cctv_make'), ['class' => 'form-control', 'placeholder' => '']) !!}
                   </div>
                   
                    
                    <div class="col-sm-2 form-group solar-fencing">
                       <label class="col-sm-12 dolstgrnving">Solar Fencing</label>
                       <label class="col-sm-12 no-of-zones">Number of zones</label>
                    ...
                    <div class="col-sm-2 form-group">
                       <label class="control-label empty">&nbsp;</label>
                       <label class="col-sm-12 length">Length </label>
				     ...
				     <div class="col-sm-2 form-group lightening-effect"> 
                       <label class="control-label empty">&nbsp;</label>
                       <label class="col-sm-12 lightening-protection">Lightening Protection </label>
          ...
          <div class="modal-body blockoverhead">
             <div class="row transofrmers">
              ...
              <div class="col-sm-3">
               ...
               <div class="col-sm-1"> <a href="#" onclick="addtransFormField(); return false;" class="adding-more" style="font-weight:bold; font-size:21px; color:#0b1cff; text-decoration:none; text-align:center;display:inline-block;width:auto;">+</a></div>
              </div>
          ...
          <div class="row transofrmers">
            ...
            <div class="col-sm-3 form-group"> 
              ...
              <div class="row transofrmers">
                ...
                <div class="col-sm-3 form-group">  <input type="file" class="form-control" name="transfilename[]"   />
                </div>   
          ...
          <div class="modal-body blockoverhead">
           ...
           <div class="row dg-teransfermers">
            ...
            <div class="col-sm-2 form-group"> 
                ...
                <div class="col-sm-3 form-group">  <input type="file" class="form-control" name="dgfilename[]"   />
                </div>   
...
{!! Form::submit('Next', ['class' => 'btn btn-danger btn-register']) !!}
{!! Form::close() !!}
...
function addFormField() {
	...
	function addtransFormField() {
		...
		$("#divTxttrans").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+parseInt( cn )+"</span></div><div class='col-sm-3 form-group'><input type='text' name='transcapacity[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='translocation[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='transmake[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='file' name='transfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removetransFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	function addpwrbkpFormField() {
		...
		if($("#feet").val()!=null) feet=$("#feet").val();  
			...
			$("#divTxtpwrbkp").append("<div class='row transofrmers solarpwrcls' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+ parseInt( cn ) +"</span></div><div class='col-sm-2 form-group'><input type='text' name='solarpwrcapacity[]' class='form-control'/> <input type='hidden' name='spid[]' value='0'></div><div class='col-sm-3 form-group'><input type='text' name='solarpwrlocation[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='solarpwrmake[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='file' name='solarpwrfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removepwrbkpFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
  ...
  // DGSETS
	...
	function adddgsFormField() {
		...
		$("#divTxtdgs").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+ parseInt( cn ) +"</span></div><div class='col-sm-2 form-group'><input type='text' name='dgcapacity[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='text' name='dglocation[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='dgmake[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='file' name='dgfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removedgsFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
...
//STP
	...
	function addstpFormField() {
		...
		$("#divTxtstp").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+parseInt( cn )+"</span></div><div class='col-sm-2 form-group'><input type='text' name='stpphase[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='stptechnology[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='stpcapacity[]' class='form-control'/></div><div class='col-sm-1 form-group'><input type='text' name='stpmake[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='file' name='stpfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removestpFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	function addwspFormField() {
		...
		$("#divTxtwsp").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+parseInt( cn )+"</span></div><div class='col-sm-2 form-group'><input type='text' name='wspphase[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='wspcapacity[]' class='form-control'/></div> <input type='hidden' name='ws_id[]' value='0'><div class='col-sm-2 form-group'><input type='text' name='wspmake[]' class='form-control'/></div><div class='col-sm-4 form-group'><input type='file' name='wspfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removewspFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	function removewspFormField(id) {
		...
		$("#divTxtwsp").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+parseInt( cn )+"</span></div><div class='col-sm-3 form-group'><input type='text' name='wspphcapacity[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='text' name='wspphmake[]' class='form-control'/></div><div class='col-sm-4 form-group'><input type='file' name='wspphfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removewspphFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	function removewspphFormField(id) {
	 ...
	 function addgasbFormField() {
		...
		$("#divTxtgasb").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+ parseInt( cn )+"</span></div><div class='col-sm-2 form-group'><input type='text' name='gabankname[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='galocation[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='gacapacity[]' class='form-control'/></div><div class='col-sm-1 form-group'><input type='text' name='gamake[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='file' name='gafilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removestpFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	// SOLAR WATER HEATERS
		...
		$("#divTxtsolarwh").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+ parseInt( cn )+"</span></div><div class='col-sm-3 form-group'><input type='text' name='solarcapacity[]' class='form-control'/><input type='hidden' name='solid[]' value='0'/></div><div class='col-sm-4 form-group'><input type='text' name='solarlocation[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='text' name='solarmake[]' class='form-control'/></div><div class='col-sm-1 form-group'><a href='#' onClick='removefirealFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	// FIREALARAM SYATEM
		...
		$("#divTxtfirealaramsy").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+parseInt( cn )+"</span></div><div class='col-sm-3 form-group'><input type='text' name='faslocation[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='text' name='fasmake[]' class='form-control'/></div><div class='col-sm-4 form-group'><input type='file' name='fasfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removefirealFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	function removefirealFormField(id) {
		...
		$("#divTxtflwannsy").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+parseInt( cn )+"</span></div><div class='col-sm-2 form-group'><input type='text' name='faslocation[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='fasmake[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='flowanzone[]' class='form-control'/></div><div class='col-sm-4 form-group'><input type='file' name='fasfilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removeflzFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	// BOOM BARIER
		...
		$("#divTxtbmbr").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+parseInt( cn )+"</span></div><div class='col-sm-4 form-group'><input type='text' name='bmbrlocation[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='text' name='bmbrmake[]' class='form-control'/></div><div class='col-sm-3 form-group'><input type='text' name='bmbrlength[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removebmbrFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	function addpubadFormField() {
		...
		$("#divTxtpubadsy").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+ parseInt( cn )+"</span></div><div class='col-sm-3 form-group'><input type='text' name='pbalocation[]' class='form-control'/><input type='hidden' name='pbaid[]' value='0'></div><div class='col-sm-3 form-group'><input type='text' name='pbamake[]' class='form-control'/></div><div class='col-sm-4 form-group'><input type='file' name='pbafilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removepublicaddFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	$("#postpaiddiv").append("<div class='row pumnphysro postpaidmaint' id='row" + id + "'><div class='col-sm-1 form-group numbering'><label>"+parseInt( cn )+"</label></div><div class='col-sm-5 form-group'><input type='text'  name='post_start_date[]' class='form-control datetpickpop'  /></div><div class='col-sm-5 form-group'><input type='text' name='post_end_date[]' class='form-control datetpickpop' /></div><div class='col-sm-1'><a href='#' onClick='removepostpaidFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>" );
	...
	function addpmpadFormField() {
		...
		$("#divTxtpumprmsy").append("<div class='row transofrmers' id='row" + id + "'><div class='col-sm-1 form-group numbering'><span>"+ parseInt( cn )+"</span></div><div class='col-sm-2 form-group'><input type='text' name='pmplocation[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='jockey[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='main[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='dg[]' class='form-control'/></div><div class='col-sm-2 form-group'><input type='text' name='booster[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removepumpaddFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>");
	...
	// LIFTS
		...
		$("#divTxtlifts").append("<div class='row pumnphysro reolistsinfo' id='row" + id + "'><div class='col-sm-1 form-group numbering'><label>"+ parseInt(vid)+"</label></div><div class='col-sm-3 form-group'><input type='text' name='lift_num[]' class='form-control  liftscnval'  /></div><div class='col-sm-4 form-group'><input type='text'  class='form-control '  name='make[]' /></div><div class='col-sm-3 form-group'><input type='text'  name='type[]' class='form-control ' /></div><div class='col-sm-1'><a href='#' onClick='removeliftsFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>" );
	...
	// HYDRO WATER PUMPS
		...
		$("#divTxthydro").append("<div class='row pumnphysro pumping-system' id='row" + id + "'><div class='col-sm-1 numbering'><span>2</span></div><div class='col-sm-2 form-group numbering'><input type='text'  class='form-control' name='num_of_pumps[]'  /><input type='hidden' name='hy_id[]' value='0'></div><div class='col-sm-2 form-group'><input type='text'  class='form-control' name='hydromake' /></div><div class='col-sm-3 form-group'><input type='text' name='hydrocapacity[]' class='form-control '  /></div><div class='col-sm-3 form-group'><input type='file' name='hydrofilename[]' class='form-control'/></div><div class='col-sm-1'><a href='#' onClick='removeliftsFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div></div>" );
