	...
	.errval
   {
    ...
    <title>Water Source and Consumption</title>
@extends('layouts.app')
...
<div class="docs-main watersource-editpage">
        ...
        <h3><b>Water source and consumption <span style="color:#ff2518;"><?php echo $report_on; ?></b></h3></span>
		{!! Form::open(['method' => 'POST', 'route' => ['misreports.storewaterconsump'], 'class' => 'for-labelling' ,'onsubmit' =>"return subform()"]) !!}
