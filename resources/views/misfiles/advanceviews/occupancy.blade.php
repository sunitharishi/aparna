...
<div class="col-md-12 col-sm-12 col-xs-12" style="padding-left:0px;padding-right:0px;">
	...
	<div class="manjeera">
                      ...
                      <table width="100%" border="1" cellspacing="0">
                        <tbody>
                          <tr>
                           <th colspan="10" style="font-size:15px;text-align:center;background-color:#2f4050;color:#fff;"> Occupancy & Rental Details as on <span style="color:#ffd800;"><?php echo $report_on; ?></span></th>
                          </tr>
                      <tr style="background-color:#e9c085;">
                        ...
                        <th  colspan="4" style="text-align:center;">Prevailing rent per month (INR)</th>
						...
						<td class="text-center"> <b><?php if(isset($existing[$key]['owners'])) { echo $existing[$key]['tenants']; } ?></b> </td>
						<td class="text-center"><b><?php if(isset($existing[$key]['owners'])) { echo $existing[$key]['vacant']; } ?> </b></td>
                        <!-- {!! Form::text('ctptmax[]', '', ['class' => 'larev2', 'placeholder' => '']) !!}-->
						<td class="text-center"><span><?php if(isset($cost[$key]['one_bhk'])) { echo $cost[$key]['one_bhk']; } ?> </span></td>
