...
<div class="col-md-12 col-sm-12 col-xs-12 superboy1">
	...
	<div class="row">
                 <h3><b> Occupancy & Rental Details as on<span style="color:#ff2518;"> <?php echo $report_on; ?></span></b></h3> 
			...
			{!! Form::hidden('year',$report_year, ['class' => 'larev', 'placeholder' => '','id' => 'year']) !!}
              {{ Form::hidden('site', '',['id' => 'siteid', 'placeholder' => '']) }}
			     ...
			     <tr>
                     ...
                     <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2"  style="width:100px;">Total Occupied</th>
					 <td style="width:100px;">{!! Form::text('occupied','', ['class' => ' ', 'placeholder' => '', 'id' => 'occupied_id','onchange' => 'getvalidVal(this.value)','readonly' => 'true']) !!} </td>
                  </tr>
                  <tr>
                     <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"  style="width:80px;">Owners</th>
					 <td style="width:80px;">{!! Form::text('owners','', ['class' => ' ', 'placeholder' => '', 'id' => 'owners_id','onchange' => 'getvalidSum(this.value)']) !!} </td>
                  </tr>
                  <tr>
                     <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"  style="width:80px;">Tenants</th>
				     <td style="width:80px;">{!! Form::text('tenants','', ['class' => ' ', 'placeholder' => '', 'id' => 'tenants_id','onchange' => 'getvalidSum(this.value)']) !!} </td>
                  </tr>
                  <tr>
                     <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"  style="width:80px;">Vacant</th>
				     <td style="width:80px;">{!! Form::text('vacant','', ['class' => '', 'placeholder' => '', 'id' => 'vacant_id','onchange' => 'getvalidSum(this.value)']) !!} </td>
 ...
 $( document ).ready(function() {
	...
	//AJAX CALL
	   ...
	   $.ajax({
				...
				cache:false,
				dataType: "json",
				url: '{{ route('validation.getmsvalues') }}',
