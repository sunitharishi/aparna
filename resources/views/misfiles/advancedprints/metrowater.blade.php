...
<div class="manjeera">
                     <?php // echo "<pre>"; print_r($sitearr); echo "</pre>"; ?>
                      <table  border="1" cellspacing="0">
                        <tbody>
                          <tr>
                           <th colspan="<?php echo count($sitearr['community']) + 2; ?>" style="font-size:15px;text-align:center;background-color:#009933;">Metro Water Supply details from  <?php echo $reportfrom_on."<span> to </span> ".$report_on; ?></th>
                          </tr> 
                          <tr>
