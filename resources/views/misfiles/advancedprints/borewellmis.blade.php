...
<div class="col-md-12 col-sm-12 col-xs-12" style="padding-left:0px;padding-right:0px;">
              <div class="x_panel tile fixed_height_400 reason-for-failure">
                ...
                <div class="x_content housesco2 look-like">
    
<div class="manjeera">
                      <table width="100%" border="1" cellspacing="0">
                        <tbody>
                          <tr>
                           <th colspan="15" style="font-size:15px;text-align:center;background-color:#2f4050;color:#fff;">Bore well not working status as on <span style="color:#ffd800;"> <?php echo $report_on; ?></span></th>
                          </tr>
                      <tr style="background-color:#e9c085;">
                       ...
                       <!-- <th rowspan="3">Total<br> Units </th>  
                        ...
                        <td> <b><?php     if(isset($borewellsnum[$key])) echo $borewellsnum[$key]; ?></b></td> 
