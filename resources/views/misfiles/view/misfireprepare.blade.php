...
<div class="col-md-12 col-sm-12 col-xs-12 mis-trainingoperation-viewpage">
	...
	<div class="manjeera firessafety-preparedness">
                    <h3 class="firesafety-viewheading" style="text-align:center;">Fire Safety Preparedness &amp; Fire Alarm Operation Training</h3>
	 ...
	 var thisvalue = $( this ).text();
	  var selectedText = $(this).find("option:selected").text();
	   ...
	   $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('validation.getprepareexport') }}',
