...
@foreach ($res as $record)
  <?php /*?><div style="float: left;" id="image_<?php echo $record['id']; ?>">
  	<div style="width:200px; text-align:center;">
    <img class="unbelievable" src="<?php echo "/".$record['image_url'];  ?>" style="height:200px"><br/>
	</div>
    <div><?php echo $record['title']; ?></div>
    <div style="cursor: pointer;" onclick="imgDelete(<?php echo $record['id']; ?>);">Delete</div>
 </div><?php */?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="fa fa-print" aria-hidden="true"></i>  Edit Mock Drill</h4>
        </div>
...
<script type="text/javascript">
        function imgDelete(dis)
        {
          ...
          if(answer)
          {
            ...
            type: "get",
            cache:false,
            url: '{{ route('validation.mocdelete') }}',
            data: { imageId: dis},
		...
		function submitFire()
		{
			...
			type: "get",
			cache:false,
			url: '{{ route('validation.mockdrillupdate') }}',
