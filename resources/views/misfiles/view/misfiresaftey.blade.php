   ...
   <!-- <link href="vendors1/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>-->
    ...
    <style>
	.dscription-issue tbody tr td
	{
	 padding:2px;
	 font-size:11px;
	}
	.dscription-issue tbody tr th
	{
	 padding:2px;
	 font-size:11px;
	}
	
	.pump-report1 tbody tr th 
	{
	padding:5px;
	font-size:11px;
	}
	.pump-report1 tbody tr td 
	{
	padding:5px;
	font-size:11px;
	}
...
<div class="col-md-12 col-sm-12 col-xs-12" style="padding-left:0px;padding-right:0px;">
	...
	<?php //echo "<pre>"; print_r($issuetemp); echo "</pre>"; ?>
     ...
     <?php $keysarray =array("1"=>"Jockey Pump","2"=>"Main Pump","3"=>"DG Pump","4"=>"Booster Pumps","5"=>"Dewatering Pumps","6"=>"Yard Hydrant Points","7"=>"Cellar Hydrant Points","8"=>"Sub Cellar Hydrant Points","9"=>"Fire Hose Reel Drums","10"=>"Fire Alarm System","11"=>"Public Addressing System","12"=>"Fire Extinguishers","13"=>"Carbon Emission System","14"=>"Flow Meter Paneles - Fire Sprinkler","15"=>"CP Hoses","16"=>"Fire Alaram Repeater Panels","17"=>"Sprinkler Charged (floor wise)","18"=>"Fire Mock Drill & Emergency Evacuation","19"=>"False Fire Alarms","20"=>"Wet Raisers","21"=>"Sub Cellar-3 Hydrant Points","22"=>"PA System Repeater Panel","23"=>"Group Indication Panel"); ?>
                        ...
                        <div class="firesafety-statustable" style="margin-bottom:10px;">
                           <table width="100%" border="1" cellspacing="0" class="pump-report1" >
                        <tbody>
                          <tr>
                           <th colspan="9" style="font-size:15px;text-align:center;background-color:#2f4050;color:#fff;"> <span style="color:#ffd800;"><?php echo get_sitename($ikey); ?> </span> Status as on<span style="color:#ffd800;"> <?php echo  $report_on ?></span></th>
                          </tr>
                      <tr style="background-color:#e9c085;">
                        ...
                        <th colspan="3" style="text-align:center;">Fire pumps Status  </th>
                         <th rowspan="2"  class="text-center">Total downtime (Hrs/days) of all Equipment</th>
                       </tr>
                          
                        <tr style="background-color:#a99f91;">
                         <th class="text-center">Total</th>
                         <th style="width:80px;" class="text-center">Not Working</th>
                        ...
                        <td class="text-center"><span><?php if(isset($misres[$ikey]['jk_pump_nw'])) echo $misres[$ikey]['jk_pump_nw']; ?><?php if(isset($misprevious[$ikey]['jk_pump_nw'])) { if((int)$misprevious[$ikey]['jk_pump_nw'] > 0 ) echo  "(".$misprevious[$ikey]['jk_pump_nw'].")"; } ?></span> </td>
                        ...
                        <td class="text-center"><span><?php if(isset($misres[$ikey]['main_pump_nw'])) echo $misres[$ikey]['main_pump_nw']; ?><?php if(isset($misprevious[$ikey]['main_pump_nw'])) { if((int)$misprevious[$ikey]['main_pump_nw'] > 0 ) echo  "(".$misprevious[$ikey]['main_pump_nw'].")"; } ?></span> </td>
                        ...
                        <td class="text-center"><span><?php if(isset($misres[$ikey]['dg_pump_nw'])) echo $misres[$ikey]['dg_pump_nw']; ?><?php if(isset($misprevious[$ikey]['dg_pump_nw'])) { if((int)$misprevious[$ikey]['dg_pump_nw'] > 0 ) echo  "(".$misprevious[$ikey]['dg_pump_nw'].")"; } ?></span> </td>
                        ...
                        <td class="text-center"><span><?php if(isset($misres[$ikey]['boostr_pump_nw'])) echo $misres[$ikey]['boostr_pump_nw']; ?><?php if(isset($misprevious[$ikey]['boostr_pump_nw'])) { if((int)$misprevious[$ikey]['boostr_pump_nw'] > 0 ) echo  "(".$misprevious[$ikey]['boostr_pump_nw'].")"; } ?></span> </td>
                        ...
                        <td class="text-center"><span><?php if(isset($misres[$ikey]['dewatr_pump_nw'])) echo $misres[$ikey]['dewatr_pump_nw']; ?><?php if(isset($misprevious[$ikey]['dewatr_pump_nw'])) { if((int)$misprevious[$ikey]['dewatr_pump_nw'] > 0 ) echo  "(".$misprevious[$ikey]['dewatr_pump_nw'].")"; } ?></span> </td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['yard_hyd_pns'])) echo $misres[$ikey]['yard_hyd_pns']; ?><?php if(isset($misprevious[$ikey]['yard_hyd_pns'])) { if((int)$misprevious[$ikey]['yard_hyd_pns'] > 0 ) echo  "(".$misprevious[$ikey]['yard_hyd_pns'].")"; } ?></span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['cell_hyd_pns'])) echo $misres[$ikey]['cell_hyd_pns']; ?><?php if(isset($misprevious[$ikey]['cell_hyd_pns'])) { if((int)$misprevious[$ikey]['cell_hyd_pns'] > 0 ) echo  "(".$misprevious[$ikey]['cell_hyd_pns'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['sbcell_hyd_pns'])) echo $misres[$ikey]['sbcell_hyd_pns']; ?><?php if(isset($misprevious[$ikey]['sbcell_hyd_pns'])) { if((int)$misprevious[$ikey]['sbcell_hyd_pns'] > 0 ) echo  "(".$misprevious[$ikey]['sbcell_hyd_pns'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['frhsreel_drums'])) echo $misres[$ikey]['frhsreel_drums']; ?><?php if(isset($misprevious[$ikey]['frhsreel_drums'])) { if((int)$misprevious[$ikey]['frhsreel_drums'] > 0 ) echo  "(".$misprevious[$ikey]['frhsreel_drums'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['firealarm_sysm'])) echo $misres[$ikey]['firealarm_sysm']; ?><?php if(isset($misprevious[$ikey]['firealarm_sysm'])) { if((int)$misprevious[$ikey]['firealarm_sysm'] > 0 ) echo  "(".$misprevious[$ikey]['firealarm_sysm'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['pa_sysm'])) echo $misres[$ikey]['pa_sysm']; ?><?php if(isset($misprevious[$ikey]['pa_sysm'])) { if((int)$misprevious[$ikey]['pa_sysm'] > 0 ) echo  "(".$misprevious[$ikey]['pa_sysm'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['fire_exting_sysm'])) echo $misres[$ikey]['fire_exting_sysm']; ?><?php if(isset($misprevious[$ikey]['fire_exting_sysm'])) { if((int)$misprevious[$ikey]['fire_exting_sysm'] > 0 ) echo  "(".$misprevious[$ikey]['fire_exting_sysm'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['carbn_emiss_sysm'])) echo $misres[$ikey]['carbn_emiss_sysm']; ?><?php if(isset($misprevious[$ikey]['carbn_emiss_sysm'])) { if((int)$misprevious[$ikey]['carbn_emiss_sysm'] > 0 ) echo  "(".$misprevious[$ikey]['carbn_emiss_sysm'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['flow_mtr_fire_sprink'])) echo $misres[$ikey]['flow_mtr_fire_sprink']; ?><?php if(isset($misprevious[$ikey]['flow_mtr_fire_sprink'])) { if((int)$misprevious[$ikey]['flow_mtr_fire_sprink'] > 0 ) echo  "(".$misprevious[$ikey]['flow_mtr_fire_sprink'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['cp_hoses'])) echo $misres[$ikey]['cp_hoses']; ?><?php if(isset($misprevious[$ikey]['cp_hoses'])) { if((int)$misprevious[$ikey]['cp_hoses'] > 0 ) echo  "(".$misprevious[$ikey]['cp_hoses'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['fire_ala_rep_panel'])) echo $misres[$ikey]['fire_ala_rep_panel']; ?><?php if(isset($misprevious[$ikey]['fire_ala_rep_panel'])) { if((int)$misprevious[$ikey]['fire_ala_rep_panel'] > 0 ) echo  "(".$misprevious[$ikey]['fire_ala_rep_panel'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['sprink_charged'])) echo $misres[$ikey]['sprink_charged']; ?><?php if(isset($misprevious[$ikey]['sprink_charged'])) { if((int)$misprevious[$ikey]['sprink_charged'] > 0 ) echo  "(".$misprevious[$ikey]['sprink_charged'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                        <td><span><?php  if(isset($misres[$ikey]['sprink_charged_dwn_tm'])) echo $misres[$ikey]['sprink_charged_dwn_tm']; ?></span></td>
                         ...
                         <td class="text-center"><b>Prev: <span><?php  if(isset($misres[$ikey]['fire_mock_drill'])) echo $misres[$ikey]['fire_mock_drill']; ?></b> </span></td>
                         <td class="text-center"><b>Next: <span><?php  if(isset($misres[$ikey]['fire_mock_drill_next'])) echo $misres[$ikey]['fire_mock_drill_next']; ?></b> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['false_alaram_sys'])) echo $misres[$ikey]['false_alaram_sys']; ?><?php if(isset($misprevious[$ikey]['false_alaram_sys'])) { if((int)$misprevious[$ikey]['false_alaram_sys'] > 0 ) echo  "(".$misprevious[$ikey]['false_alaram_sys'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['wet_raiser'])) echo $misres[$ikey]['wet_raiser']; ?><?php if(isset($misprevious[$ikey]['wet_raiser'])) { if((int)$misprevious[$ikey]['wet_raiser'] > 0 ) echo  "(".$misprevious[$ikey]['wet_raiser'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['pa_sys_panel'])) echo $misres[$ikey]['pa_sys_panel']; ?><?php if(isset($misprevious[$ikey]['pa_sys_panel'])) { if((int)$misprevious[$ikey]['pa_sys_panel'] > 0 ) echo  "(".$misprevious[$ikey]['pa_sys_panel'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
                       ...
                       <td class="text-center"><span><?php  if(isset($misres[$ikey]['gr_ind_panel'])) echo $misres[$ikey]['gr_ind_panel']; ?><?php if(isset($misprevious[$ikey]['gr_ind_panel'])) { if((int)$misprevious[$ikey]['gr_ind_panel'] > 0 ) echo  "(".$misprevious[$ikey]['gr_ind_panel'].")"; } ?></span></td>
                        <td colspan="3" class="text-center"><span> </span></td>
					   ...
					   <div class="codel-infoirmation"> <?php  if(isset($misres[$ikey]['additional_info'])){ $te = strip_tags($misres[$ikey]['additional_info']); if($te) { echo "<b>Note:</b>".$misres[$ikey]['additional_info']; } } ?></div> 
                          ...
                          <div class="firesafety-equipment1table" style="margin-bottom:15px;">
						   <table width="100%" border="1" cellspacing="0" class="dscription-issue" >
                        <tbody>
                          <tr>
                       ...
                       <tr style="background-color:#e9c085;" class="text-center">
                        <td class="text-center"><b>Category</b></td>
                         ...
                         <div class="firesafety-equipment2table" style="margin-bottom:10px;">
						       <table width="100%" border="1" cellspacing="0" class="pump-report1">
                        <tbody>
                          <tr>
                           <th colspan="<?php echo (int)$issuecn + 1;   ?>" style="font-size:15px;text-align:center;background-color:#2f4050;color:#fff;"> <span style="color:#ffd800;"><?php echo get_sitename($ikey); ?> </span> Equipment Not working Data</th>
