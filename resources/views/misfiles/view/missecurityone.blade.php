...
<div class="col-md-12 col-sm-12 col-xs-12 mis-dailysecurity-page" style="padding-left:0px;padding-right:0px;">
                     ...
                     <div class="security1-viewtable">
                      ...
                      <td class="text-left"><b>Supervisors</b></td>
                       ...
                       <?php foreach($existsectwo['bicycle'] as $skey => $siterec) { ?>
                        <th ><span> <?php echo $existsectwo['bicycle_num'][$skey]."/".$siterec; ?> </span></th>
                       <?php }?>
                          </tr>
                       ...
                       <?php foreach($existsectwo['computer'] as $skey => $siterec) { ?>
                        <th ><span> <?php echo $existsectwo['computers_num'][$skey]."/".$siterec; ?> </span></th>
                       <?php }?>
                          </tr>
                       ...
                       <?php }?>
                             ...
                             <tr>
                       <th style="background-color:#cce0d0;" class="text-left">Torch Lights</th>
                        <td class="secuhr text-left"><b>Not working / Total</b></td>
                      ...
                      <td class="text-left"><b>Supervisors</b></td>
                       ...
                       <?php foreach($existsec['bicycle'] as $skey => $siterec) { ?>
                        <th ><span> <?php echo $existsec['bicycle_num'][$skey]."/".$siterec; ?> </span></th>
                       <?php }?>
                          </tr>
                       ...
                       <?php foreach($existsec['computer'] as $skey => $siterec) { ?>
                        <th ><span> <?php echo $existsec['computers_num'][$skey]."/".$siterec; ?> </span></th>
                       <?php }?>
                          </tr>
                      ...
                      </table></div> <?php } if(!isset($existsectwo['sites']) && !isset($existsec['sites'])) { ?>
