...
{!! Form::open(['method' => 'POST', 'route' => ['misreports.storemishorticulture'], 'class' => 'for-labelling' ,'onsubmit' =>"return subform()"]) !!}
<div class="col-md-12 col-sm-12 col-xs-12 heatly-welcome1">
              <div class="x_panel tile fixed_height_400 heatly-welcome">
                <div class="x_title">
                   <!--<h3>Metro Water Supply details from  01.12.2017 to 31.12.2017</h3>-->
                </div>
                <div class="x_content housesco1">
    
	<div class="docs-main grid-views" >
	    
          <h3>Horticulture - Pesticides/Fertilizers and Fungicides Consumption Report </h3>     
...
<div class="dlyrep-select fire2mis invaluable">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left:0px;padding-right:0px;">
              <div class="x_panel tile fixed_height_400" style="padding-left:0px;padding-right:0px;">
                ...
                <div class="x_content bunnnyyy">
    
    
	<div class="docs-main horticulture-editpage">   
	 ...
	 var thisvalue = $( this ).text();
	  var selectedText = $(this).find("option:selected").text();
	   ...
	   $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('validation.gethorticulturemsvalues') }}',
