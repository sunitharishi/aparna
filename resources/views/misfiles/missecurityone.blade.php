...
.security-reason1
 ...
 .dlyrep-select.fire2mis.invaluable label
 {
  width: 40px;
  float: left;
  color: #ff2518;
 ...
 .dlyrep-select.fire2mis.invaluable select
 {
  float:left;
  width:200px;
 }
...
{!! Form::open(['method' => 'POST', 'route' => ['misreports.storemissecurity'], 'class' => 'for-labelling' ,'onsubmit' =>"return subform()"]) !!}
<div class="col-md-12 col-sm-12 col-xs-12 security-reason1">
              <div class="x_panel tile fixed_height_400 security-reason">
                <div class="x_title">
	...
	<div class="docs-main ">
        ...
        <h3 class="daily-security-data">Daily Security Data </h3>    
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
              <div class="x_panel tile fixed_height_400" style="padding:6px 0px;">
                <div class="x_title">
                   <!--<h3>Metro Water Supply details from  01.12.2017 to 31.12.2017</h3>-->
                </div>
	...
	<div class="docs-main securityreport-editpage">   
	 ...
	 var thisvalue = $( this ).text();
	  var selectedText = $(this).find("option:selected").text();
	   ...
	   $.ajax({
				type: "get",
				cache:false,
				url: '{{ route('validation.getsecuritymsvalues') }}',
