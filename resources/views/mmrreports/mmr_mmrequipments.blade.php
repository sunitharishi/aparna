...
<div class="mmrreport-eading">
    <h2 class="main-heading">MMR REPORT FOR THE MONTH OF <?php echo $monthname; ?>-<?php echo $report_year; ?></h2>
	 ...
	 <?php } ?>
      <div class="incident-summary"><?php echo $tCount; ?>.	Equipment Status</div>
    <div class="manjeera" style="margin-bottom:0px;">
        ...
        <div class="" style="margin-bottom:0px;">
            <table width="100%" border="1" cellspacing="0" class="primary-table1  <?php  if(isset($misres[$ikey]['additional_info'])){ $te = strip_tags($misres[$ikey]['additional_info']); if($te) { echo 'equadditionin'; } } ?>" style="margin-bottom:0px;">
                <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td class="sarlef"><b>Solar Fencing</b></td>
