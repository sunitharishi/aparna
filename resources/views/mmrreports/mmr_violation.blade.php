...
<div class="row">  
    <div class="scope-nature">
        ...
        <div class="incident-summary">Violations</div>
            	...
            	<tr>
                    ...
                    <td style="width:160px;text-align:center;">
                       <div class="list house-img">
                         ...
                         <img src="<?php  echo url('/')."/hosekpact/tiny_".$val->before_image;?>" style="width:150px;height:150px;" class="img-thumbnail">
                       </div>
                        <div class="work-completion"> <b style="font-size:11px;">Before work completion</b></div>
                     </td>
                     <?php }} ?> 
                      <?php if(isset($val->after_image)) { if($val->after_image) { ?>
                     <td style="width:160px;text-align:center;">
                          <div class="list house-img">
                      
                       <img src="<?php  echo url('/')."/hosekpact/tiny_".$val->after_image;?>" style="width:150px;height:150px;" class="img-thumbnail">
                       </div>
