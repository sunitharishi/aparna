...
.previewprrrr {page-break-after:always !important;
	...
	.description-root-cause1 tbody tr td.text-center
	{
	 text-align:center;
	}
	.description-root-cause1 tbody tr th.text-center
	{
	 text-align:center;
	}
   ...
   padding:8px 5px;
	...
	.description-root-cause1 thead tr th
	{
	  font-size:13px;
    padding:8px 5px;
...
<div class="manjeera">
    ...
    <?php //echo "<pre>"; print_r($issues[$ikey]); echo "</pre>"; exit; ?>
