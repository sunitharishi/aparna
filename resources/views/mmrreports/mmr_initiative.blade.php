...
<div class="row">  
    <div class="scope-nature">
        <div class="incident-summary">Initiative taken / Proactive</div>
            ...
            @if(count($resval) > 0)
             @foreach($resval as $k => $val)
            	<tr>
                    ...
                    <td><?php if(isset($val->beforeimage)) { if($val->beforeimage) { ?><img src="<?php  echo public_path('/')."hosekpact/tiny_".$val->beforeimage;?>" style="width:100px; height:100px";><?php }} ?></td>
                       <td><?php if(isset($val->afterimage)) { if($val->afterimage) { ?><img src="<?php  echo public_path('/')."hosekpact/tiny_".$val->afterimage;?>" style="width:100px; height:100px";><?php }} ?></td>
                </tr>
                @endforeach
            @endif     
            </tbody>
