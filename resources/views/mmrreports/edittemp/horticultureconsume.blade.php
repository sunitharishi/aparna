...
<div class="col-sm-12 mmr-housekeeping-heading horticulture-consumables">



    <h3 class="page-title"><span class="mmr"> HORTICULTURE CONSUMABLES</span>
...
<div class="col-sm-12">
  ...
  <div class="horticulture-consumablesform">

   <div class="horticulture-activities">

 {!! Form::open(['files' => 'true','method' => 'POST', 'route' => ['mmr.storehousekpconsume'], 'class' => 'for-labelling']) !!}
 ...
 <div class="row mmr-housekeeping-editpage">
      ...
      <div class="col-sm-2 col-xs-2 mmr-horticon-date">
       ...
       <div class="col-sm-2 col-xs-2 mmr-horticon-remarks" >
    ...
    foreach($pbasys as $dgcon) { //echo "<pre>"; print_r($dgcon); echo "</pre>";?>
     ...
     <div class="col-sm-1 col-xs-1 form-group serial-number">
        ...
        <div class="col-sm-3 col-xs-3 form-group">
         ...
         <div class="col-sm-2 col-xs-2 form-group mmr-horticon-date">

             <input type="text" class="form-control example1" name="report_on[]" value="<?php echo  date("d-m-Y",strtotime($dgcon['report_on'])); ?>"  />

      </div>

       <div class="col-sm-2 col-xs-2 form-group mmr-horticon-remarks">
...
function addpubadFormField() {
		...
		$("#divTxtpubadsy").append("<div class='row mmr-housekeeping-adding' id='row" + id + "'><div class='col-sm-1 col-xs-1 form-group serial-number'><span>"+ parseInt( cn )+"</span></div><div class='col-sm-2 col-xs-2 form-group'><input type='text' name='category[]' class='form-control'/><input type='hidden' name='pbaid[]' value='0'></div><div class='col-sm-2 col-xs-2 form-group'><input type='text' name='location[]' class='form-control'/></div><div class='col-sm-3 col-xs-3 form-group'><input type='text' name='description[]' class='form-control'/></div><div class='col-sm-2 col-xs-2 form-group mmr-horticon-date'><input type='text' name='report_on[]' class='form-control example1'/></div><div class='col-sm-2 col-xs-2 form-group mmr-horticon-remarks'><input type='text' name='remarks[]' class='form-control'/></div><a href='#' onClick='removepublicaddFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div>");
