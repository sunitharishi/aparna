...
@section('content')
<div class="col-sm-12 mmr-housekeeping-heading initiative-taken">

    <h3 class="page-title"><span class="mmr"> INITIATIVE TAKEN / PROACTIVE</span>
    </h3>
...
<div class="col-sm-12">
  ...
  <div class="initiativetaken-proactiveform">
    <div class="initiativetaken-proactiveinner">
    ...
    {!! Form::hidden('type','initiative', ['class' => 'larev', 'placeholder' => '']) !!} 
 ...
 <div class="row mmr-housekeeping-editpage">
     <div class="col-sm-1 col-xs-1 serial-number">
       ...
       <div class="col-sm-1 col-xs-1 mmr-initiative-category">
         <label>Category</label>
         
  </div>
      <div class="col-sm-1 col-xs-1 mmr-initiative-location">
  ...
  <div class="col-sm-2 col-xs-2 mmr-initiative-date">
         <label>Date</label>
         
  </div>
   <div class="col-sm-1 col-xs-1 mmr-initiative-remarks" >
         <label>Remarks</label>
    ...
    foreach($pbasys as $dgcon) { //echo "<pre>"; print_r($dgcon); echo "</pre>";?>
     ...
     <div class="col-sm-1 col-xs-1 form-group serial-number">
        <span><?php $mgp = $mgp + 1; echo $mgp; ?></span>
         ...
         <div class="col-sm-1 col-xs-1 form-group mmr-initiative-category">
        ...
        <div class="col-sm-1 col-xs-1 form-group mmr-initiative-location">
...
function addpubadFormField() {
		...
		$("#divTxtpubadsy").append("<div class='row mmr-housekeeping-adding' id='row" + id + "'><div class='col-sm-1 col-xs-1 form-group serial-number'><span>"+ parseInt( cn )+"</span></div><div class='col-sm-1 col-xs-1 form-group mmr-initiative-category'><input type='text' name='category[]' class='form-control'/><input type='hidden' name='pbaid[]' value='0'></div><div class='col-sm-1 col-xs-1 form-group mmr-initiative-location'><input type='text' name='location[]' class='form-control'/></div><div class='col-sm-2 col-xs-2 form-group'><input type='text' name='description[]' class='form-control'/></div><div class='col-sm-2 col-xs-2 form-group mmr-initiative-date'><input type='text' name='report_on[]' class='form-control example1'/></div><div class='col-sm-1 col-xs-1 form-group mmr-initiative-remarks'><input type='text' name='remarks[]' class='form-control'/></div><div class='col-sm-2 col-xs-2 form-group'><input type='file' name='beforeimage[]' class='form-control'/></div><div class='col-sm-2 col-xs-2 form-group'><input type='file' name='afterimage[]' class='form-control'/></div><a href='#' onClick='removepublicaddFormField(\"#row" + id + "\"); return false;' class='remove removerla'>X</a></div>");
