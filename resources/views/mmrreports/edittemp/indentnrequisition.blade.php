...
@section('content')
<div class="col-sm-12 mmr-housekeeping-heading mmr-indenstsnrequisition">
    <h3 class="page-title"><span class="mmr"> INDENTS AND REQUISITION</span>
    </h3>
...
<div class="col-sm-12 indents-and-requistion">  
   <div class="showing-month-details form-group">
         ...
         {!! Form::open(['files' => 'true','method' => 'POST', 'route' => ['mmr.storemmrmonthly'], 'class' => 'for-labelling']) !!}
            ...
            {!! Form::hidden('type','indentreq', ['class' => 'larev', 'placeholder' => '']) !!}
