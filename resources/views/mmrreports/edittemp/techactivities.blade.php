...
@section('content')
<div class="col-sm-12 mmr-housekeeping-heading housekeeping-activities">
    <h3 class="page-title"><span class="mmr"> Technical Activities</span>
    </h3>
    <span class="mmr-back">
...
<div class="showing-month-details form-group">
	<h3> {{ $sitename }}
        ...
        <div class="mmrupdate-page housekeeping-activitiess">
          <div class="housekeeping-activitiesform">
         {!! Form::open(['files' => 'true','method' => 'POST', 'route' => ['mmr.storehousekpact'], 'class' => 'for-labelling']) !!}
            ...
            {!! Form::hidden('month',$month, ['class' => 'larev', 'placeholder' => '','id' =>'month']) !!}
             {!! Form::hidden('type','technical_activities', ['class' => 'larev', 'placeholder' => '']) !!} 
...
<div class="row mmr-housekeeping-editpage">
         <div class="col-sm-1 col-xs-1 serial-number">
           ...
           <div class="col-sm-1 col-xs-1 mmr-house-category">
             <label>Category</label>
             
      </div>
          <div class="col-sm-1 col-xs-1 mmr-house-location">
      ...
      <div class="col-sm-2 col-xs-2 mmr-house-date">
             <label>Date</label>
             
      </div>
       <div class="col-sm-1 col-xs-1 mmrhouse-category-remarks" >
             <label>Remarks</label>
        ...
        foreach($pbasys as $dgcon) { //echo "<pre>"; print_r($dgcon); echo "</pre>";?>
         ...
         <div class="col-sm-1 col-xs-1 form-group serial-number">
            <span><?php $mgp = $mgp + 1; echo $mgp; ?></span>
             ...
             <div class="col-sm-1 col-xs-1 form-group mmr-house-category">
            ...
            <div class="col-sm-1 col-xs-1 form-group mmr-house-location">
