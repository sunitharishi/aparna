...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel mmr-wsp-inlet">
        <div class="x_content">
             <h3><b>Metro Test Reports (WSP - Outlet) </b>
             </h3>
        </div>
         {!! Form::open(['files' => 'true','method' => 'POST', 'route' => ['mmr.storewsptestreport1'], 'class' => 'for-labelling']) !!}
        	...
        	<div class="mmr-wsp-inlet-table">
        			...
        			<table>
        				...
        				<tbody>
        					...
        					<tr>
        						...
        						<td rowspan="2"><b>WSP - Outlet</b></td>
               ...
               <div class="table-responsive">
       			...
       			<div class="table-responsive" style="width:660px; margin:15px auto;">
                    ...
                    <div style="float:left; margin-left:20px;"><input type="file" name="wspoutlet_pic" /></div>
                    <?php if(isset($pbasys['wspoutlet_pic']) && $pbasys['wspoutlet_pic']!="") { ?>
					<div id="delete_<?php echo  $pbasys['id']; ?>"><a href="/<?php echo $pbasys['wspoutlet_pic']; ?>" target="_blank">View Image</a> &nbsp; | &nbsp;  <a href="javasript:void(0)" onclick="deleteImage(<?php echo $pbasys['id']; ?>,'','wspoutlet','<?php echo $pbasys['wspoutlet_pic']; ?>')">Delete</a></div>
                    <?php } ?>
                </div>
